---
title: "4.9 已建立连接的TCP，收到SYN会发生什么？"
...
created: "2026-08-13"
type: "reference"
summary: "小林coding《图解网络》官网目录第 4.9 已建立连接的TCP，收到SYN会发生什么？ 篇。"
source: "https://xiaolincoding.com/network/3_tcp/challenge_ack.html"
author: "小林coding"
...
<!-- WIKI_NAV_START -->
> [!info] 图解网络导航
> [[00｜图解网络目录|返回图解网络目录]] · [[4.8 SYN 报文什么情况下会被丢弃？|← 上一篇：4.8 SYN 报文什么情况下会被丢弃？]] · [[4.10 四次挥手中收到乱序的 FIN 包会如何处理？|下一篇：4.10 四次挥手中收到乱序的 FIN 包会如何处理？ →]]
<!-- WIKI_NAV_END -->


> [!info] 原文信息
> 原文：[4.9 已建立连接的TCP，收到SYN会发生什么？](https://xiaolincoding.com/network/3_tcp/challenge_ack.html)
> 提取：Defuddle 0.19.2
...
![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-001.jpg)
...
![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-002.png)
...
![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-003.png)
...
- TCP A will continue to try to establish the connection;
...
我们只关注 tcp\_validate\_incoming 函数是怎么处理 SYN 报文的，精简后的代码如下：

![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-004.png)

从上面的代码实现可以看到，处于 Established 状态的服务端，在收到报文后，首先会判断序列号是否在窗口内，如果不在，则看看 RST 标记有没有被设置，如果有就会丢掉。然后如果没有 RST 标志，就会判断是否有 SYN 标记，如果有 SYN 标记就会跳转到 syn\_challenge 标签，然后执行 tcp\_send\_challenge\_ack 函数。

tcp\_send\_challenge\_ack 函数里就会调用 tcp\_send\_ack 函数来回复一个携带了正确序列号和确认号的 ACK 报文。
...
![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-005.png)
...
![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-006.png)
...
![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-007.png)
...
![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-008.png)

接着，在客户端机子上，用 nc 工具模拟一个 TCP 客户端，连接我们刚才启动的服务端，并且指定了客户端的端口为 11111。

![](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-009.png)

这时候， 服务端就可以看到这条 TCP 连接了。

![图片](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-010.png)
...
![图片](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-011.png)

可以看到，tcpkill 工具阻塞中，没有任何输出，而且此时的 TCP 连接还是存在的，并没有被干掉。

![图片](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-012.png)
...
![图片](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-013.png)

可以看到，在发送了「hi」数据后，客户端就断开了，并且错误提示连接被对方关闭了。

此时，服务端已经查看不到刚才那条 TCP 连接了。

![图片](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-014.png)

然后，我们在服务端看看 tcpkill 工具输出的信息。

![图片](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-015.png)
...
![图片](../../../../../assets/图解网络-小林coding/21-challenge_ack/img-016.png)
