...
chapter: "04｜内存管理篇"
order: "4.7"
source: "https://xiaolincoding.com/os/3_memory/linux_mem2.html"
author: "小林coding"
...
> [!info] 阅读导航
> [[4.6 深入理解 Linux 虚拟内存管理|← 上一篇：4.6 深入理解 Linux 虚拟内存管理]] ｜ [[projects/嵌入式八股/4. 小林图解/图解系统/04｜内存管理篇/index|本篇目录]] ｜ [[projects/嵌入式八股/4. 小林图解/图解系统/index|全书目录]] ｜ [[5.1 进程、线程基础知识|下一篇：5.1 进程、线程基础知识 →]]
