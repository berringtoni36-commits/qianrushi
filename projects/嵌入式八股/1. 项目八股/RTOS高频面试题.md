...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第97题：信号量和互斥量有什么区别？|150题 97：信号量和互斥量有什么区别]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第96题：FreeRTOS 队列有什么作用？|150题 96：FreeRTOS 队列有什么作用]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/01 C-C++基础（1-25题）#第8题：堆和栈有什么区别？|150题 8：堆和栈有什么区别]]
> 📎 同类八股：[[#同类八股-第8题：堆和栈有什么区别？|嵌入式八股150题#第8题：堆和栈有什么区别？]]
## A4. FreeRTOS 任务栈大小的单位是字还是字节？栈溢出会造成什么风险？

> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第104题：如何判断 FreeRTOS 任务栈是否够用？|150题 104：判断 FreeRTOS 任务栈是否够用]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第93题：FreeRTOS 的任务调度机制是什么？|150题 93：FreeRTOS 的任务调度机制是什么]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/03 MCU-STM32（51-70题）#第51题：STM32 启动流程大致是什么？|150题 51：STM32 启动流程大致是什么]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/03 MCU-STM32（51-70题）#第66题：PWM 是什么？定时器如何产生 PWM？|150题 66：PWM 是什么？定时器如何产生 PWM]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/02 C++进阶（26-50题）#第26题：C++ 面向对象的三大特性是什么？|150题 26：C++ 面向对象的三大特性是什么]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/04 通信协议-网络（71-90题）#第82题：SPI 的 CPOL 和 CPHA 是什么？|150题 82：SPI 的 CPOL 和 CPHA 是什么]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第95题：什么是优先级反转？如何解决？|150题 95：优先级反转？如何解决]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第98题：二值信号量和计数信号量有什么区别？|150题 98：二值信号量和计数信号量有什么区别]]
> 📎 同类八股：[[#同类八股-第98题：二值信号量和计数信号量有什么区别？|嵌入式八股150题#第98题：二值信号量和计数信号量有什么区别？]]

## A19. 请说一下 FreeRTOS 的动态内存管理方式。

> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第103题：FreeRTOS 的 heap_1 到 heap_5 有什么区别？|150题 103：FreeRTOS 的 heap_1 到 heap…]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/01 C-C++基础（1-25题）#第9题：全局变量、局部变量和静态变量分别存放在哪里？|150题 9：全局变量、局部变量和静态变量分别存放在哪里]]
> 📎 同类八股：[[#同类八股-第9题：全局变量、局部变量和静态变量分别存放在哪里？|嵌入式八股150题#第9题：全局变量、局部变量和静态变量分别存放在哪里？]]

## A22. 请说一下内存泄漏的原因。

> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/01 C-C++基础（1-25题）#第12题：什么是内存泄漏？如何避免？|150题 12：内存泄漏？如何避免]]
> 📎 同类八股：[[#同类八股-第12题：什么是内存泄漏？如何避免？|嵌入式八股150题#第12题：什么是内存泄漏？如何避免？]]

## A23. GPIO 配置为输入模式时，上拉和下拉电阻有什么作用？

> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/03 MCU-STM32（51-70题）#第64题：GPIO 常见工作模式有哪些？|150题 64：GPIO 常见工作模式有哪些]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第91题：裸机和 RTOS 有什么区别？|150题 91：裸机和 RTOS 有什么区别]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/03 MCU-STM32（51-70题）#第53题：什么是中断？|150题 53：中断]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第102题：中断和任务之间如何同步？|150题 102：中断和任务之间如何同步]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/05 RTOS-FreeRTOS（91-105题）#第94题：FreeRTOS 任务优先级如何设计？|150题 94：FreeRTOS 任务优先级如何设计]]
...
> [!tip] 🔁 通用八股入口
> - [[projects/嵌入式八股/2. 嵌入式高频八股150题/03 MCU-STM32（51-70题）#第63题：Flash 写入和掉电保护要注意什么？|150题 63：Flash 写入和掉电保护要注意什么]]
...
> 来源：[[嵌入式高频八股150题(全)#第13题：栈溢出是什么？如何避免？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第104题：如何判断 FreeRTOS 任务栈是否够用？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第51题：STM32 启动流程大致是什么？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第56题：SysTick 在嵌入式系统中有什么作用？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第52题：Bootloader 有什么作用？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第81题：SPI 的基本通信原理是什么？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第82题：SPI 的 CPOL 和 CPHA 是什么？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第93题：FreeRTOS 的任务调度机制是什么？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第95题：什么是优先级反转？如何解决？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第98题：二值信号量和计数信号量有什么区别？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第103题：FreeRTOS 的 heap_1 到 heap_5 有什么区别？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第9题：全局变量、局部变量和静态变量分别存放在哪里？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第12题：什么是内存泄漏？如何避免？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第91题：裸机和 RTOS 有什么区别？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第96题：FreeRTOS 队列有什么作用？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第102题：中断和任务之间如何同步？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第94题：FreeRTOS 任务优先级如何设计？|嵌入式八股150题]]
...
> 来源：[[嵌入式高频八股150题(全)#第63题：Flash 写入和掉电保护要注意什么？|嵌入式八股150题]]
