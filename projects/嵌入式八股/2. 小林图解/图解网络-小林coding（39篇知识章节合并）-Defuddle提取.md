---
title: "图解网络｜小林coding（39篇知识章节合并）"
tags: [计算机网络, HTTP, TCP, IP, 嵌入式, 面试八股]
created: 2026-08-12
type: permanent
summary: "按小林coding官网目录合并的计算机网络基础、HTTP、TCP与IP知识章节。"
...
> [!info] 提取说明
> 来源：[小林coding《图解网络》](https://xiaolincoding.com/network/)
> 提取工具：Defuddle 0.19.2
> 范围：网络基础篇、HTTP篇、TCP篇、IP篇，共 39 篇知识正文。
> 处理：保留原文知识内容、代码、列表和图片；删除首页宣传、站点 UI、文章末尾推广及上一篇/下一篇导航。
...
> [!info] 原文信息
> 原文：[2.1 TCP/IP 网络模型有哪几层？](https://xiaolincoding.com/network/1_base/tcp_ip_model.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-001.png)
...
![](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-002.png)
...
![](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-003.png)

网络层最常使用的是 IP 协议（ *Internet Protocol* ），IP 协议会将传输层的报文作为数据部分，再加上 IP 包头组装成 IP 报文，如果 IP 报文大小超过 MTU（以太网中一般为 1500 字节）就会 **再次进行分片** ，得到一个即将发送到网络的 IP 报文。

![](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-004.png)
...
![img](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-005.jpg)

将 255.255.255.0 取反后与IP地址进行进行 **按位与运算** ，就可以得到主机号。

大家可以去搜索下子网掩码计算器，自己改变下「掩码位」的数值，就能体会到子网掩码的作用了。

![子网掩码计算器](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-006.png)
...
![IP地址的网络号](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-007.png)
...
![](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-008.png)
...
![](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-009.png)

再给大家贴一下每一层的封装格式：

![img](../../../assets/图解网络-小林coding/01-tcp_ip_model/img-010.png)
...
> [!info] 原文信息
> 原文：[2.2 键入网址到网页显示，期间发生了什么？](https://xiaolincoding.com/network/1_base/what_happen_url.html)
> 提取：Defuddle 0.19.2
...
![简单的网络模型](../../../assets/图解网络-小林coding/02-what_happen_url/img-001.png)
...
![URL 解析](../../../assets/图解网络-小林coding/02-what_happen_url/img-002.jpg)
...
![HTTP 的消息格式](../../../assets/图解网络-小林coding/02-what_happen_url/img-003.png)
...
![DNS 树状结构](../../../assets/图解网络-小林coding/02-what_happen_url/img-004.png)
...
![域名解析的工作流程](../../../assets/图解网络-小林coding/02-what_happen_url/img-005.png)
...
![](../../../assets/图解网络-小林coding/02-what_happen_url/img-006.png)
...
![TCP 包头格式](../../../assets/图解网络-小林coding/02-what_happen_url/img-007.png)
...
![TCP 三次握手](../../../assets/图解网络-小林coding/02-what_happen_url/img-008.png)
...
![TCP 连接状态查看](../../../assets/图解网络-小林coding/02-what_happen_url/img-009.png)

> TCP 分割数据

如果 HTTP 请求消息比较长，超过了 `MSS` 的长度，这时 TCP 就需要把 HTTP 的数据拆解成一块块的数据发送，而不是一次性发送所有数据。

![MTU 与 MSS](../../../assets/图解网络-小林coding/02-what_happen_url/img-010.png)
...
![数据包分割](../../../assets/图解网络-小林coding/02-what_happen_url/img-011.png)
...
![TCP 层报文](../../../assets/图解网络-小林coding/02-what_happen_url/img-012.png)
...
![IP 包头格式](../../../assets/图解网络-小林coding/02-what_happen_url/img-013.jpg)
...
![路由表](../../../assets/图解网络-小林coding/02-what_happen_url/img-014.png)

举个例子，根据上面的路由表，我们假设 Web 服务器的目标地址是 `192.168.10.200` 。

![路由规则判断](../../../assets/图解网络-小林coding/02-what_happen_url/img-015.png)

1. 首先先和第一条目的子网掩码（ `Genmask` ）进行 **与运算** ，得到结果为 `192.168.10.0` ，但是第一个条目的 `Destination` 是 `192.168.3.0` ，两者不一致所以匹配失败。
2. 再与第二条目的子网掩码进行 **与运算** ，得到的结果为 `192.168.10.0` ，与第二条目的 `Destination 192.168.10.0` 匹配成功，所以将使用 `eth1` 网卡的 IP 地址作为 IP 包头的源地址。

假设 Web 服务器的目标地址是 `10.100.20.100` ，那么依然按照上面的路由表规则判断，判断后的结果是和第三条目匹配。
...
![IP 层报文](../../../assets/图解网络-小林coding/02-what_happen_url/img-016.jpg)
...
![MAC 包头格式](../../../assets/图解网络-小林coding/02-what_happen_url/img-017.png)
...
![ARP 广播](../../../assets/图解网络-小林coding/02-what_happen_url/img-018.png)
...
![ARP 缓存内容](../../../assets/图解网络-小林coding/02-what_happen_url/img-019.png)

> MAC 报文生成

至此，网络包的报文如下图。

![MAC 层报文](../../../assets/图解网络-小林coding/02-what_happen_url/img-020.jpg)
...
![数据包](../../../assets/图解网络-小林coding/02-what_happen_url/img-021.png)
...
下面来看一下包是如何通过交换机的。交换机的设计是将网络包 **原样** 转发到目的地。

我们常说的普通交换机，核心工作是对以太网数据帧做二层转发，全程不会修改帧里的源 MAC 地址和目的 MAC 地址；它工作在 OSI 网络模型的 **数据链路层（二层）** ，因此也被叫做 **二层网络设备** 。

> 交换机的包接收操作

首先，从终端发来的以太网电信号，会通过网线到达交换机的对应端口。交换机的端口物理芯片会先接收信号，把连续的电信号转换成能处理的数字信号。

随后，交换机会通过帧末尾的 **FCS（帧校验序列）** 检查数据有没有在传输过程中出错，如果校验失败会直接丢弃这个帧，校验无误的话，就把完整的以太网帧存入这个端口的接收缓冲区。

这部分信号转换、差错校验的底层操作，和我们电脑里的网卡几乎一模一样，但二者的核心工作逻辑天差地别。
...
![交换机的 MAC 地址表](../../../assets/图解网络-小林coding/02-what_happen_url/img-022.jpg)
...
数据包在局域网内经过交换机完成终端之间的转发后，就会到达 **路由器** ，由它把数据包转发到外网的下一个路由器，或是跨网段的目标设备。

路由器和交换机的转发逻辑有一个共同点：都靠 「查表」 来决定数据包该发到哪，但二者查的表、转发的规则、负责的工作完全不一样。

二者最核心的区别，在于工作的网络层级和能力边界，具体如下：

- **路由器** 是工作在网络层的 **三层设备** ，核心是基于 IP 地址做跨网段转发，俗称网络的 「出口大门」。它的每个负责路由转发的端口，都有专属的 MAC 地址和 IP 地址，既能识别二层以太网帧，也能处理三层 IP 包。
- **普通二层交换机** 是工作在数据链路层的 **二层设备** ，核心是基于 MAC 地址做同局域网内的终端转发，俗称局域网的 「内部枢纽」。它的每个物理端口都有自己的 MAC 地址，但 **本身没有 IP 地址** ，只识别和处理以太网帧，不处理 IP 层的内容。
...
![路由器转发](../../../assets/图解网络-小林coding/02-what_happen_url/img-023.png)
...
![网络分层模型](../../../assets/图解网络-小林coding/02-what_happen_url/img-024.png)
...
> [!info] 原文信息
> 原文：[2.3 Linux 系统是如何收发网络包的？](https://xiaolincoding.com/network/1_base/how_os_deal_network_package.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/03-how_os_deal_network_package/img-001.png)
...
![](../../../assets/图解网络-小林coding/03-how_os_deal_network_package/img-002.png)
...
![](../../../assets/图解网络-小林coding/03-how_os_deal_network_package/img-003.png)
...
![](../../../assets/图解网络-小林coding/03-how_os_deal_network_package/img-004.png)

### Linux 发送网络包的流程

如上图的右半部分，发送网络包的流程正好和接收流程相反。

首先，应用程序会调用 Socket 发送数据包的接口，由于这个是系统调用，所以会从用户态陷入到内核态中的 Socket 层，内核会申请一个内核态的 sk\_buff 内存， **将用户待发送的数据拷贝到 sk\_buff 内存，并将其加入到发送缓冲区** 。

接下来，网络协议栈从 Socket 发送缓冲区中取出 sk\_buff，并按照 TCP/IP 协议栈从上到下逐层处理。

如果使用的是 TCP 传输协议发送数据，那么 **先拷贝一个新的 sk\_buff 副本** ，这是因为 sk\_buff 后续在调用网络层，最后到达网卡发送完成的时候，这个 sk\_buff 会被释放掉。而 TCP 协议是支持丢失重传的，在收到对方的 ACK 之前，这个 sk\_buff 不能被删除。所以内核的做法就是每次调用网卡发送的时候，实际上传递出去的是 sk\_buff 的一个拷贝，等收到 ACK 再真正删除。
...
![](../../../assets/图解网络-小林coding/03-how_os_deal_network_package/img-005.jpg)
...
第一次，调用发送数据的系统调用的时候，内核会申请一个内核态的 sk\_buff 内存，将用户待发送的数据拷贝到 sk\_buff 内存，并将其加入到发送缓冲区。

第二次，在使用 TCP 传输协议的情况下，从传输层进入网络层的时候，每一个 sk\_buff 都会被克隆一个新的副本出来。副本 sk\_buff 会被送往网络层，等它发送完的时候就会释放掉，然后原始的 sk\_buff 还保留在传输层，目的是为了实现 TCP 的可靠传输，等收到这个数据包的 ACK 时，才会释放原始的 sk\_buff 。

第三次，当 IP 层发现 sk\_buff 大于 MTU 时才需要进行。会再申请额外的 sk\_buff，并将原来的 sk\_buff 拷贝为多个小的 sk\_buff。
...
- Linux 网络包发送过程：https://mp.weixin.qq.com/s/wThfD9th9e\_-YGHJJ3HXNQ
- Linux 网络数据接收流程（TCP）- NAPI：https://wenfh2020.com/2021/12/29/kernel-tcp-receive/
- Linux网络-数据包接收过程：https://blog.csdn.net/frank\_jb/article/details/115841622
...
> [!info] 原文信息
> 原文：[3.1 HTTP 常见面试题](https://xiaolincoding.com/network/2_http/http_interview.html)
> 提取：Defuddle 0.19.2
...
![HTTP 常见面试题提纲](../../../assets/图解网络-小林coding/04-http_interview/img-001.png)
...
![三个部分](../../../assets/图解网络-小林coding/04-http_interview/img-002.png)
...
![三方协议和租房协议](../../../assets/图解网络-小林coding/04-http_interview/img-003.png)
...
![请求 - 应答](../../../assets/图解网络-小林coding/04-http_interview/img-004.png)
...
![ 五大类 HTTP 状态码 ](../../../assets/图解网络-小林coding/04-http_interview/img-005.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-006.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-007.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-008.png)

HTTP 长连接的特点是，只要任意一端没有明确提出断开连接，则保持 TCP 连接状态。

![HTTP 长连接](../../../assets/图解网络-小林coding/04-http_interview/img-009.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-010.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-011.png)
...
![GET 请求](../../../assets/图解网络-小林coding/04-http_interview/img-012.png)

根据 RFC 规范， **POST 的语义是根据请求负荷（报文body）对指定的资源做出处理** ，具体的处理方式视资源类型而不同。POST 请求携带数据的位置一般是写在报文 body 中，body 中的数据可以是任意格式的数据，只要客户端与服务端协商好即可，而且浏览器不会对 body 大小做限制。

比如，你在我文章底部，敲入了留言后点击「提交」（ **暗示你们留言** ），浏览器就会执行一次 POST 请求，把你的留言文字放进了报文 body 里，然后拼接好 POST 请求头，通过 TCP 协议发送给服务器。

![POST 请求](../../../assets/图解网络-小林coding/04-http_interview/img-013.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-014.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-015.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-016.png)
...
![Cookie 技术](../../../assets/图解网络-小林coding/04-http_interview/img-017.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-018.png)
...
![短连接与长连接](../../../assets/图解网络-小林coding/04-http_interview/img-019.png)
...
![管道网络传输](../../../assets/图解网络-小林coding/04-http_interview/img-020.png)
...
![队头阻塞](../../../assets/图解网络-小林coding/04-http_interview/img-021.png)
...
![HTTP 与 HTTPS 网络层](../../../assets/图解网络-小林coding/04-http_interview/img-022.jpg)
...
![混合加密](../../../assets/图解网络-小林coding/04-http_interview/img-023.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-024.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-025.png)
...
![数子证书工作流程](../../../assets/图解网络-小林coding/04-http_interview/img-026.jpg)
...
![HTTPS 连接建立过程](../../../assets/图解网络-小林coding/04-http_interview/img-027.jpg)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-028.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-029.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-030.png)

操作系统里一般都会内置一些根证书，比如我的 MAC 电脑里内置的根证书有这么多：

![](../../../assets/图解网络-小林coding/04-http_interview/img-031.png)

这样的一层层地验证就构成了一条信任链路，整个证书信任链验证流程如下图所示：

![](../../../assets/图解网络-小林coding/04-http_interview/img-032.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-033.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-034.jpg)

这个问题的场景是这样的：客户端通过浏览器向服务端发起 HTTPS 请求时，被「假基站」转发到了一个「中间人服务器」，于是客户端是和「中间人服务器」完成了 TLS 握手，然后这个「中间人服务器」再与真正的服务端完成 TLS 握手。

![](../../../assets/图解网络-小林coding/04-http_interview/img-035.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-036.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-037.png)
...
![HTT/1 ~ HTTP/2](../../../assets/图解网络-小林coding/04-http_interview/img-038.jpg)
...
![HTTP/1 与 HTTP/2 ](../../../assets/图解网络-小林coding/04-http_interview/img-039.png)

这样虽然对人不友好，但是对计算机非常友好，因为计算机只懂二进制，那么收到报文后，无需再将明文的报文转成二进制，而是直接解析二进制报文，这 **增加了数据传输的效率** 。

比如状态码 200 ，在 HTTP/1.1 是用 '2''0''0' 三个字符来表示（二进制：00110010 00110000 00110000），共用了 3 个字节，如下图

![img](../../../assets/图解网络-小林coding/04-http_interview/img-040.png)

在 HTTP/2 对于状态码 200 的二进制编码是 10001000，只用了 1 字节就能表示，相比于 HTTP/1.1 节省了 2 个字节，如下图：

![img](../../../assets/图解网络-小林coding/04-http_interview/img-041.png)

Header::status: 200 OK 的编码内容为：1000 1000，那么表达的含义是什么呢？

![](../../../assets/图解网络-小林coding/04-http_interview/img-042.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-043.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-044.jpg)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-045.png)

再比如，客户端通过 HTTP/1.1 请求从服务器那获取到了 HTML 文件，而 HTML 可能还需要依赖 CSS 来渲染页面，这时客户端还要再发起获取 CSS 文件的请求，需要两次消息往返，如下图左边部分：

![img](../../../assets/图解网络-小林coding/04-http_interview/img-046.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-047.jpg)

举个例子，如下图：

![img](../../../assets/图解网络-小林coding/04-http_interview/img-048.gif)
...
![HTTP/1 ~ HTTP/3](../../../assets/图解网络-小林coding/04-http_interview/img-049.jpg)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-050.jpg)
...
![TCP HTTPS（TLS/1.3） 和 QUIC HTTPS ](../../../assets/图解网络-小林coding/04-http_interview/img-051.jpg)

甚至，在第二次连接的时候，应用数据包可以和 QUIC 握手信息（连接信息 + TLS 信息）一起发送，达到 0-RTT 的效果。

如下图右边部分，HTTP/3 当会话恢复时，有效负载数据与第一个数据包一起发送，可以做到 0-RTT（下图的右下角）：

![](../../../assets/图解网络-小林coding/04-http_interview/img-052.png)

*3、连接迁移*

基于 TCP 传输协议的 HTTP 协议，由于是通过四元组（源 IP、源端口、目的 IP、目的端口）确定一条 TCP 连接。

![TCP 四元组](../../../assets/图解网络-小林coding/04-http_interview/img-053.png)
...
![](../../../assets/图解网络-小林coding/04-http_interview/img-054.png)

另外， SSL/TLS 1.3 优化了过程，只需要 1 个 RTT 往返时延，也就是只需要 3 次握手：

![T](../../../assets/图解网络-小林coding/04-http_interview/img-055.png)
...
> [!info] 原文信息
> 原文：[3.2 HTTP/1.1 如何优化？](https://xiaolincoding.com/network/2_http/http_optimize.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/05-http_optimize/img-001.png)
...
![](../../../assets/图解网络-小林coding/05-http_optimize/img-002.png)
...
![](../../../assets/图解网络-小林coding/05-http_optimize/img-003.png)
...
![](../../../assets/图解网络-小林coding/05-http_optimize/img-004.png)

如果 **重定向的工作交由代理服务器完成，就能减少 HTTP 请求次数了** ，如下图：

![](../../../assets/图解网络-小林coding/05-http_optimize/img-005.png)

而且当代理服务器知晓了重定向规则后，可以进一步减少消息传递次数，如下图：

![](../../../assets/图解网络-小林coding/05-http_optimize/img-006.png)

除了 `302` 重定向响应码，还有其他一些重定向的响应码，你可以从下图看到：

![](../../../assets/图解网络-小林coding/05-http_optimize/img-007.png)
...
![图来源于：墨染枫林的CSDN](../../../assets/图解网络-小林coding/05-http_optimize/img-008.png)
...
![图来源于：陈健平的CSDN ](../../../assets/图解网络-小林coding/05-http_optimize/img-009.png)
...
![来源于：https://isparta.github.io/compare-webp/index.html](../../../assets/图解网络-小林coding/05-http_optimize/img-010.png)
...
> [!info] 原文信息
> 原文：[3.3 HTTPS RSA 握手解析](https://xiaolincoding.com/network/2_http/https_rsa.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-001.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-002.jpg)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-003.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-004.png)

对应 Wireshark 的抓包，我也画了一幅图，你可以从下图很清晰地看到该过程：

![](../../../assets/图解网络-小林coding/06-https_rsa/img-005.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-006.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-007.png)

可以看到，服务端选择的密码套件是 “Cipher Suite: TLS\_RSA\_WITH\_AES\_128\_GCM\_SHA256”。
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-008.png)

随后，服务端发了「 **Server Hello Done** 」消息，目的是告诉客户端，我已经把该给你的东西都给你了，本次打招呼完毕。

![](../../../assets/图解网络-小林coding/06-https_rsa/img-009.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-010.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-011.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-012.png)

操作系统里一般都会内置一些根证书，比如我的 MAC 电脑里内置的根证书有这么多：

![](../../../assets/图解网络-小林coding/06-https_rsa/img-013.png)

这样的一层层地验证就构成了一条信任链路，整个证书信任链验证流程如下图所示：

![](../../../assets/图解网络-小林coding/06-https_rsa/img-014.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-015.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-016.png)
...
![](../../../assets/图解网络-小林coding/06-https_rsa/img-017.png)
...
> [!info] 原文信息
> 原文：[3.4 HTTPS ECDHE 握手解析](https://xiaolincoding.com/network/2_http/https_ecdhe.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-001.png)
...
![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-002.png)

那么对于底数为 2 的时候， 32 的对数是 5，64 的对数是 6，计算过程如下：

![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-003.png)

对数运算的取值是可以连续的，而离散对数的取值是不能连续的，因此也以「离散」得名，

离散对数是在对数运算的基础上加了「模运算」，也就说取余数，对应编程语言的操作符是「%」，也可以用 mod 表示。离散对数的概念如下图：

![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-004.png)
...
![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-005.png)
...
![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-006.png)

细心的小伙伴应该发现了， **使用了 ECDHE，在 TLS 第四次握手前，客户端就已经发送了加密的 HTTP 数据** ，而对于 RSA 握手过程，必须要完成 TLS 四次握手，才能传输应用数据。

所以， **ECDHE 相比 RSA 握手过程省去了一个消息往返的时间** ，这种「抢跑」——在 TLS 握手完全完成前就发送应用数据的优化，被称为「 *TLS False Start* 」（定义于 RFC 7918），跟「 *TCP Fast Open* 」有点像，都是在还没连接完全建立前，就发送了应用数据，这样便提高了传输的效率。需要注意的是，False Start 本身是一种通用的 TLS 优化，并不是 ECDHE 独有的，只是在实践中通常与 ECDHE 等前向安全的密钥交换算法搭配使用。
...
![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-009.png)

这一步就和 RSA 握手过程有很大的区别了，因为服务端选择了 ECDHE 密钥协商算法，所以会在发送完证书后，发送「 **Server Key Exchange** 」消息。

![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-010.png)
...
![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-011.png)
...
![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-012.png)
...
![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-013.png)

接着，客户端会发「 **Encrypted Handshake Message** 」消息，把之前发送的数据做一个摘要，再用对称密钥加密一下，让服务端做个验证，验证下本次生成的对称密钥是否可以正常使用。

![](../../../assets/图解网络-小林coding/07-https_ecdhe/img-014.png)
...
> [!info] 原文信息
> 原文：[3.5 HTTPS 如何优化？](https://xiaolincoding.com/network/2_http/https_optimize.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-001.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-002.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-003.jpg)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-004.png)
...
比如在 Nginx 上，可以使用 ssl\_ecdh\_curve 指令配置想使用的椭圆曲线，把优先使用的放在前面：

![](../../../assets/图解网络-小林coding/08-https_optimize/img-005.png)

对于对称加密算法方面，如果对安全性不是特别高的要求，可以 **选用 AES\_128\_GCM** ，它比 AES\_256\_GCM 快一些，因为密钥的长度短一些。

比如在 Nginx 上，可以使用 ssl\_ciphers 指令配置想使用的非对称加密算法和对称加密算法，也就是密钥套件，而且把性能最快最安全的算法放在最前面：

![](../../../assets/图解网络-小林coding/08-https_optimize/img-006.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-007.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-008.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-009.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-010.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-011.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-012.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-013.png)
...
![](../../../assets/图解网络-小林coding/08-https_optimize/img-014.png)

同样的，Pre-shared Key 也有重放攻击的危险。

![](../../../assets/图解网络-小林coding/08-https_optimize/img-015.png)
...
> [!info] 原文信息
> 原文：[3.6 HTTP/2 牛逼在哪？](https://xiaolincoding.com/network/2_http/http2.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/09-http2/img-001.png)
...
![](../../../assets/图解网络-小林coding/09-http2/img-002.png)
...
![image-20240105142843113](../../../assets/图解网络-小林coding/09-http2/img-003.png)

根据 RFC7541 规范，如果头部字段属于静态表范围，并且 Value 是变化，那么它的 HTTP/2 头部前 2 位固定为 `01` ，所以整个头部格式如下图：

![image-20240105142857712](../../../assets/图解网络-小林coding/09-http2/img-004.png)
...
![](../../../assets/图解网络-小林coding/09-http2/img-005.png)

通过查表后，字符串 `nghttpx` 的 Huffman 编码在下图看到，共 6 个字节，每一个字符的 Huffman 编码，我用相同的颜色将他们对应起来了，最后的 7 位是补位的。

![](../../../assets/图解网络-小林coding/09-http2/img-006.png)

最终， `server` 头部的二进制数据对应的静态头部格式如下：

![image-20240105142949762](../../../assets/图解网络-小林coding/09-http2/img-007.png)
...
![image-20240105143006681](../../../assets/图解网络-小林coding/09-http2/img-008.png)
...
![HTTP/1 与 HTTP/2 ](../../../assets/图解网络-小林coding/09-http2/img-009.png)

HTTP/2 把响应报文划分成了两类 **帧（Frame）** ，图中的 HEADERS（首部）和 DATA（消息负载） 是帧的类型，也就是说一条 HTTP 响应，划分成了两类帧来传输，并且采用二进制来编码。

比如状态码 200 ，在 HTTP/1.1 是用 '2''0''0' 三个字符来表示（二进制：00110010 00110000 00110000），共用了 3 个字节，如下图

![img](../../../assets/图解网络-小林coding/09-http2/img-010.png)

在 HTTP/2 对于状态码 200 的二进制编码是 10001000，只用了 1 字节就能表示，相比于 HTTP/1.1 节省了 2 个字节，如下图：

![img](../../../assets/图解网络-小林coding/09-http2/img-011.png)

Header::status: 200 OK 的编码内容为：1000 1000，那么表达的含义是什么呢？

![img](../../../assets/图解网络-小林coding/09-http2/img-012.png)
...
![image-20240105143208962](../../../assets/图解网络-小林coding/09-http2/img-013.png)
...
![image-20240105143150947](../../../assets/图解网络-小林coding/09-http2/img-014.png)

帧类型后面的一个字节是 **标志位** ，可以保存 8 个标志位，用于携带简单的控制信息，比如：

- **END\_HEADERS** 表示头数据结束标志，相当于 HTTP/1 里头后的空行（“\\r\\n”）；
- **END\_Stream** 表示单方向数据发送结束，后续不会再有数据帧。
- **PRIORITY** 表示流的优先级；
...
![image-20240105143224839](../../../assets/图解网络-小林coding/09-http2/img-015.png)
...
![image-20240105143239921](../../../assets/图解网络-小林coding/09-http2/img-016.png)
...
![img](../../../assets/图解网络-小林coding/09-http2/img-017.jpg)

客户端和服务器 **双方都可以建立 Stream** ，因为服务端可以主动推送资源给客户端， 客户端建立的 Stream 必须是奇数号，而服务器建立的 Stream 必须是偶数号。

比如下图，Stream 1 是客户端向服务端请求的资源，属于客户端建立的 Stream，所以该 Stream 的 ID 是奇数（数字 1）；Stream 2 和 4 都是服务端主动向客户端推送的资源，属于服务端建立的 Stream，所以这两个 Stream 的 ID 是偶数（数字 2 和 4）。

![image-20240105143421889](../../../assets/图解网络-小林coding/09-http2/img-018.png)
...
![image-20240105143315109](../../../assets/图解网络-小林coding/09-http2/img-019.png)
...
![image-20240105143338707](../../../assets/图解网络-小林coding/09-http2/img-020.png)
...
![image-20240105143355912](../../../assets/图解网络-小林coding/09-http2/img-021.png)
...
> [!info] 原文信息
> 原文：[3.7 HTTP/3 强势来袭](https://xiaolincoding.com/network/2_http/http3.html)
> 提取：Defuddle 0.19.2
...
![image-20240105144308801](../../../assets/图解网络-小林coding/10-http3/img-001.png)
...
![img](../../../assets/图解网络-小林coding/10-http3/img-002.jpg)

因为 TCP 是字节流协议，TCP 层必须保证收到的字节数据是完整且有序的，如果序列号较低的 TCP 段在网络传输中丢失了，即使序列号较高的 TCP 段已经被接收了，应用层也无法从内核中读取到这部分数据，从 HTTP 视角看，就是请求被阻塞了。

举个例子，如下图：

![image-20240105144329079](../../../assets/图解网络-小林coding/10-http3/img-003.png)
...
![img](../../../assets/图解网络-小林coding/10-http3/img-004.gif)
...
![](../../../assets/图解网络-小林coding/10-http3/img-005.png)
...
![image-20240105144623562](../../../assets/图解网络-小林coding/10-http3/img-006.png)
...
![img](../../../assets/图解网络-小林coding/10-http3/img-007.gif)
...
![image-20240105144457456](../../../assets/图解网络-小林coding/10-http3/img-008.png)
...
对于静态表的变化，HTTP/2 中的 HPACK 的静态表只有 61 项，而 HTTP/3 中的 QPACK 的静态表扩大到 99 项。
...
可以看到， **动态表是具有时序性的，如果首次出现的请求发生了丢包，后续的收到请求，对方就无法解码出 QPACK 头部，因为对方还没建立好动态表，因此后续的请求解码会阻塞到首次请求中丢失的数据包重传过来** 。
...
6. https://ably.com/topic/http3?amp%3Butm\_campaign=evergreen&amp%3Butm\_source=reddit&utm\_medium=referral
...
> [!info] 原文信息
> 原文：[3.8 既然有 HTTP 协议，为什么还要有 RPC？](https://xiaolincoding.com/network/2_http/http_rpc.html)
> 提取：Defuddle 0.19.2
...
![握手建立连接流程](../../../assets/图解网络-小林coding/11-http_rpc/img-001.gif)
...
![TCP 是什么](../../../assets/图解网络-小林coding/11-http_rpc/img-002.png)
...
![01 二进制字节流](../../../assets/图解网络-小林coding/11-http_rpc/img-003.png)

正因为这个没有 **任何边界** 的特点，所以当我们选择使用 TCP 发送"夏洛"和"特烦恼"的时候，接收端收到的就是"夏洛特烦恼"，这时候接收端没发区分你是想要表达"夏洛"+"特烦恼"还是"夏洛特"+"烦恼"。

![消息对比](../../../assets/图解网络-小林coding/11-http_rpc/img-004.png)
...
![消息边界长度标志](../../../assets/图解网络-小林coding/11-http_rpc/img-005.png)
...
![四层网络协议](../../../assets/图解网络-小林coding/11-http_rpc/img-006.png)
...
![HTTP调用](../../../assets/图解网络-小林coding/11-http_rpc/img-007.png)
...
![RPC可以像调用本地方法那样调用远端方法](../../../assets/图解网络-小林coding/11-http_rpc/img-008.png)

基于这个思路，大佬们造出了非常多款式的 RPC 协议，比如比较有名的 `gRPC` ， `thrift` 。

值得注意的是，虽然大部分 RPC 协议底层使用 TCP，但实际上 **它们不一定非得使用 TCP，改用 UDP 或者 HTTP，其实也可以做到类似的功能。**

![基于TCP协议的HTTP和RPC协议](../../../assets/图解网络-小林coding/11-http_rpc/img-009.png)
...
![connection_pool](../../../assets/图解网络-小林coding/11-http_rpc/img-010.png)
...
![序列化和反序列化](../../../assets/图解网络-小林coding/11-http_rpc/img-011.png)
...
![HTTP 报文](../../../assets/图解网络-小林coding/11-http_rpc/img-012.png)
...
![HTTP 原理](../../../assets/图解网络-小林coding/11-http_rpc/img-013.png)

![RPC 原理](../../../assets/图解网络-小林coding/11-http_rpc/img-014.png)
...
> [!info] 原文信息
> 原文：[3.9 既然有 HTTP 协议，为什么还要有 WebSocket？](https://xiaolincoding.com/network/2_http/http_websocket.html)
> 提取：Defuddle 0.19.2
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-001.png)

来都来了，你就选了个角色进到了游戏界面里。

![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-002.jpg)
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/12-http_websocket/img-003.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-004.png)

比如，某度云网盘就是这么干的。所以你会发现一扫码，手机上点个确认，电脑端网页就 **秒跳转** ，体验很好。

![在这里插入图片描述](../../../assets/图解网络-小林coding/12-http_websocket/img-005.png)

像这种发起一个请求，在较长时间内等待服务器响应的机制，就是所谓的 **长轮询机制** 。我们常用的消息队列 RocketMQ 中，消费者去取数据时，也用到了这种方式。

![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-006.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-007.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-008.png)

之后，浏览器也用同样的 **公开算法** 将 `base64码` 转成另一段字符串，如果这段字符串跟服务器传回来的 **字符串一致** ，那验证通过。

![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-009.png)

就这样经历了一来一回两次 HTTP 握手，WebSocket就建立完成了，后续双方就可以使用 webscoket 的数据格式进行通信了。

![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-010.png)

#### WebSocket抓包

我们可以用wireshark抓个包，实际看下数据包的情况。

![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-011.png)

上面这张图，注意画了红框的第 `2445` 行报文，是WebSocket的 **第一次握手** ，意思是发起了一次带有 `特殊Header` 的HTTP请求。

![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-012.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-013.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-014.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-015.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-016.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-020.jpg)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-021.png)
...
![图片](../../../assets/图解网络-小林coding/12-http_websocket/img-022.png)
...
> [!info] 原文信息
> 原文：[4.1 TCP 三次握手与四次挥手面试题](https://xiaolincoding.com/network/3_tcp/tcp_interview.html)
> 提取：Defuddle 0.19.2
...
![TCP 三次握手与四次挥手面试题大纲](../../../assets/图解网络-小林coding/13-tcp_interview/img-001.jpg)

> PS：本次文章不涉及 TCP 流量控制、拥塞控制、可靠性传输等方面知识，这些知识在这篇： [你还在为 TCP 重传、滑动窗口、流量控制、拥塞控制发愁吗？看完图解就不愁了](https://xiaolincoding.com/network/3_tcp/tcp_feature.html)
...
![TCP 头格式](../../../assets/图解网络-小林coding/13-tcp_interview/img-002.png)
...
![OSI 参考模型与 TCP/IP 的关系](../../../assets/图解网络-小林coding/13-tcp_interview/img-003.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-004.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-005.png)
...
![TCP 四元组](../../../assets/图解网络-小林coding/13-tcp_interview/img-006.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-007.png)
...
![UDP 头部格式](../../../assets/图解网络-小林coding/13-tcp_interview/img-008.png)
...
- UDP 是不可靠的传输协议，不保证可靠交付数据，数据发送之后，丢失了就丢失了。但是我们可以基于 UDP 传输协议实现一个可靠的传输协议，比如 QUIC 协议，具体可以参见这篇文章： [如何基于 UDP 协议实现可靠传输？](https://xiaolincoding.com/network/3_tcp/quic.html)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-009.png)
...
![img](../../../assets/图解网络-小林coding/13-tcp_interview/img-010.jpg)
...
![TCP 三次握手](../../../assets/图解网络-小林coding/13-tcp_interview/img-011.png)

- 一开始，客户端和服务端都处于 `CLOSE` 状态。先是服务端主动监听某个端口，处于 `LISTEN` 状态

![第一个报文 —— SYN 报文](../../../assets/图解网络-小林coding/13-tcp_interview/img-012.png)

- 客户端会随机初始化序号（ `client_isn` ），将此序号置于 TCP 首部的「序号」字段中，同时把 `SYN` 标志位置为 `1` ，表示 `SYN` 报文。接着把第一个 SYN 报文发送给服务端，表示向服务端发起连接，该报文不包含应用层数据，之后客户端处于 `SYN-SENT` 状态。

![第二个报文 —— SYN + ACK 报文](../../../assets/图解网络-小林coding/13-tcp_interview/img-013.png)

- 服务端收到客户端的 `SYN` 报文后，首先服务端也随机初始化自己的序号（ `server_isn` ），将此序号填入 TCP 首部的「序号」字段中，其次把 TCP 首部的「确认应答号」字段填入 `client_isn + 1`, 接着把 `SYN` 和 `ACK` 标志位置为 `1` 。最后把该报文发给客户端，该报文也不包含应用层数据，之后服务端处于 `SYN-RCVD` 状态。

![第三个报文 —— ACK 报文](../../../assets/图解网络-小林coding/13-tcp_interview/img-014.png)
...
![TCP 连接状态查看](../../../assets/图解网络-小林coding/13-tcp_interview/img-015.png)
...
![三次握手避免历史连接](../../../assets/图解网络-小林coding/13-tcp_interview/img-016.png)
...
![两次握手无法阻止历史连接](../../../assets/图解网络-小林coding/13-tcp_interview/img-017.png)
...
有人问：客户端发送三次握手（ack 报文）后就可以发送数据了，而被动方此时还是 syn\_received 状态，如果 ack 丢了，那客户端发的数据是不是也白白浪费了？

不是的，即使服务端还是在 syn\_received 状态，收到了客户端发送的数据，还是可以建立连接的，并且还可以正常收到这个数据包。这是因为数据报文中是有 ack 标识位，也有确认号，这个确认号就是确认收到了第二次握手。如下图：

![](../../../assets/图解网络-小林coding/13-tcp_interview/img-018.png)
...
![四次握手与三次握手](../../../assets/图解网络-小林coding/13-tcp_interview/img-019.png)
...
![两次握手会造成资源浪费](../../../assets/图解网络-小林coding/13-tcp_interview/img-020.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-021.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-022.png)
...
![MTU 与 MSS](../../../assets/图解网络-小林coding/13-tcp_interview/img-023.png)
...
![握手阶段协商 MSS](../../../assets/图解网络-小林coding/13-tcp_interview/img-024.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-025.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-026.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-027.png)
...
![SYN 攻击](../../../assets/图解网络-小林coding/13-tcp_interview/img-028.png)
...
![正常流程](../../../assets/图解网络-小林coding/13-tcp_interview/img-029.png)
...
![tcp_syncookies 应对 SYN 攻击](../../../assets/图解网络-小林coding/13-tcp_interview/img-030.png)
...
![客户端主动关闭连接 —— TCP 四次挥手](../../../assets/图解网络-小林coding/13-tcp_interview/img-031.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-032.png)
...
举个例子，假设 tcp\_orphan\_retries 参数值为 2，当第二次挥手一直丢失时，发生的过程如下图：

![](../../../assets/图解网络-小林coding/13-tcp_interview/img-033.png)

具体过程：

- 当客户端超时重传 2 次 FIN 报文后，由于 tcp\_orphan\_retries 为 2，已达到最大重传次数，于是再等待一段时间（时间为上一次超时时间的 2 倍），如果还是没能收到服务端的第二次挥手（ACK 报文），那么客户端就会断开连接。
...
服务端处于 CLOSE\_WAIT 状态时，调用了 close 函数，内核就会发出 FIN 报文，同时连接进入 LAST\_ACK 状态，等待客户端返回 ACK 来确认连接关闭。

如果迟迟收不到这个 ACK，服务端就会重发 FIN 报文，重发次数仍然由 `tcp_orphan_retrie` s 参数控制，这与客户端重发 FIN 报文的重传次数控制方式是一样的。

举个例子，假设 `tcp_orphan_retrie` s = 3，当第三次挥手一直丢失时，发生的过程如下图：

![](../../../assets/图解网络-小林coding/13-tcp_interview/img-036.png)
...
举个例子，假设 tcp\_orphan\_retries 为 2，当第四次挥手一直丢失时，发生的过程如下：

![](../../../assets/图解网络-小林coding/13-tcp_interview/img-037.png)
...
可以看到 **2MSL时长** 这其实是相当于 **至少允许报文丢失一次** 。比如，若 ACK 在一个 MSL 内丢失，这样被动方重发的 FIN 会在第 2 个 MSL 内到达，TIME\_WAIT 状态的连接可以应对。
...
![TCP 抓包图](../../../assets/图解网络-小林coding/13-tcp_interview/img-038.png)

通过前面我们知道， **序列号和初始化序列号并不是无限递增的，会发生回绕为初始值的情况，这意味着无法根据序列号来判断新老数据** 。

假设 TIME-WAIT 没有等待时间或时间过短，被延迟的数据包抵达后会发生什么呢？

![TIME-WAIT 时间过短，收到旧连接的数据报文](../../../assets/图解网络-小林coding/13-tcp_interview/img-039.png)
...
为了防止历史连接中的数据，被后面相同四元组的连接错误的接收，因此 TCP 设计了 TIME\_WAIT 状态，状态会持续 `2MSL` 时长，这个时间 **足以让两个方向上的数据包都被丢弃，使得原来连接的数据包在网络中都自然消失，再出现的数据包一定都是新建立连接所产生的。**
...
![TIME-WAIT 时间过短，没有确保连接正常关闭](../../../assets/图解网络-小林coding/13-tcp_interview/img-040.png)

服务端收到这个 RST 并将其解释为一个错误（Connection reset by peer），这对于一个可靠的协议来说不是一个优雅的终止方式。

为了防止这种情况出现，客户端必须等待足够长的时间，确保服务端能够收到 ACK，如果服务端没有收到 ACK，那么就会触发 TCP 重传机制，服务端会重新发送一个 FIN，这样一去一来刚好两个 MSL 的时间。

![TIME-WAIT 时间正常，确保了连接正常关闭](../../../assets/图解网络-小林coding/13-tcp_interview/img-041.png)
...
客户端和服务端 TIME\_WAIT 过多，造成的影响是不同的。

**如果客户端（主动发起关闭连接方）的 TIME\_WAIT 状态过多** ，占满了所有端口资源，那么就无法对「目的 IP+ 目的 PORT」都一样的服务端发起连接了，但是被使用的端口，还是可以继续对另外一个服务端发起连接的。具体可以看我这篇文章： [客户端的端口可以重复使用吗？](https://xiaolincoding.com/network/3_tcp/port.html#%E5%AE%A2%E6%88%B7%E7%AB%AF%E7%9A%84%E7%AB%AF%E5%8F%A3%E5%8F%AF%E4%BB%A5%E9%87%8D%E5%A4%8D%E4%BD%BF%E7%94%A8%E5%90%97)

因此，客户端（发起连接方）都是和「目的 IP+ 目的 PORT 」都一样的服务端建立连接的话，当客户端的 TIME\_WAIT 状态连接过多的话，就会受端口资源限制，如果占满了所有端口资源，那么就无法再跟「目的 IP+ 目的 PORT」都一样的服务端建立连接了。
...
**如果服务端（主动发起关闭连接方）的 TIME\_WAIT 状态过多** ，并不会导致端口资源受限，因为服务端只监听一个端口，而且由于一个四元组唯一确定一个 TCP 连接，因此理论上服务端可以建立很多连接，但是 TCP 连接过多，会占用系统资源，比如文件描述符、内存资源、CPU 资源、线程资源等。
...
如下的 Linux 内核参数开启后，则可以 **复用处于 TIME\_WAIT 的 socket 为新的连接所用** 。
...
这个值默认为 18000， **当系统中处于 TIME\_WAIT 的连接一旦超过这个值时，系统就会将后面的 TIME\_WAIT 连接状态重置** ，这个方法比较暴力。
...
前面介绍的方法都是试图越过 `TIME_WAIT` 状态的，这样其实不太好。虽然 TIME\_WAIT 状态持续的时间是有一点长，显得很不友好，但是它被设计来就是用来避免发生乱七八糟的事情。

《UNIX网络编程》一书中却说道： **TIME\_WAIT 是我们的朋友，它是有助于我们的，不要试图避免这个状态，而是应该弄清楚它** 。

**如果服务端要避免过多的 TIME\_WAIT 状态的连接，就永远不要主动断开连接，让客户端去断开，由分布在各处的客户端去承受 TIME\_WAIT** 。

#### 服务器出现大量 TIME\_WAIT 状态的原因有哪些？

首先要知道 TIME\_WAIT 状态是主动关闭连接方才会出现的状态，所以如果服务器出现大量的 TIME\_WAIT 状态的 TCP 连接，就是说明服务器主动断开了很多 TCP 连接。
...
![HTTP 短连接](../../../assets/图解网络-小林coding/13-tcp_interview/img-042.png)
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-043.png)
...
![HTTP 长连接超时](../../../assets/图解网络-小林coding/13-tcp_interview/img-044.png)

当服务端出现大量 TIME\_WAIT 状态的连接时，如果现象是有大量的客户端建立完 TCP 连接后，很长一段时间没有发送数据，那么大概率就是因为 HTTP 长连接超时，导致服务端主动关闭连接，产生大量处于 TIME\_WAIT 状态的连接。
...
针对这个场景下，解决的方式也很简单，调大 nginx 的 keepalive\_requests 参数就行。

#### 服务器出现大量 CLOSE\_WAIT 状态的原因有哪些？

CLOSE\_WAIT 状态是「被动关闭方」才会有的状态，而且如果「被动关闭方」没有调用 close 函数关闭连接，那么就无法发出 FIN 报文，从而无法使得 CLOSE\_WAIT 状态的连接转变为 LAST\_ACK 状态。
...
3. epoll\_wait 等待连接到来，连接到来时，调用 accept 获取已连接的 socket
...
**第二个原因** ： 第 3 步没有做，有新连接到来时没有调用 accept 获取该连接的 socket，导致当有大量的客户端主动断开了连接，而服务端没机会对这些 socket 调用 close 函数，从而导致服务端出现大量 CLOSE\_WAIT 状态的连接。

发生这种情况可能是因为服务端在执行 accept 函数之前，代码卡在某一个逻辑或者提前抛出了异常。

**第三个原因** ：第 4 步没有做，通过 accept 获取已连接的 socket 后，没有将其注册到 epoll，导致后续收到 FIN 报文的时候，服务端没办法感知这个事件，那服务端就没机会调用 close 函数了。

发生这种情况可能是因为服务端在将已连接的 socket 注册到 epoll 之前，代码卡在某一个逻辑或者提前抛出了异常。之前看到过别人解决 close\_wait 问题的实践文章，感兴趣的可以看看： [一次 Netty 代码不健壮导致的大量 CLOSE\_WAIT 连接原因分析](https://mp.weixin.qq.com/s?__biz=MzU3Njk0MTc3Ng==&mid=2247486020&idx=1&sn=f7cf41aec28e2e10a46228a64b1c0a5c&scene=21#wechat_redirect)

**第四个原因** ：第 6 步没有做，当发现客户端关闭连接后，服务端没有执行 close 函数，可能是因为代码漏处理，或者是在执行 close 函数之前，代码卡在某一个逻辑，比如发生死锁等等。

可以发现， **当服务端出现大量 CLOSE\_WAIT 状态的连接的时候，通常都是代码的问题，这时候我们需要针对具体的代码一步一步的进行排查和定位，主要分析的方向就是服务端为什么没有调用 close** 。
...
![](../../../assets/图解网络-小林coding/13-tcp_interview/img-045.png)
...
![web 服务的 心跳机制](../../../assets/图解网络-小林coding/13-tcp_interview/img-046.png)
...
![基于 TCP 协议的客户端和服务端工作](../../../assets/图解网络-小林coding/13-tcp_interview/img-047.png)
...
- 半连接队列（SYN 队列）：接收到一个 SYN 建立连接请求，处于 SYN\_RCVD 状态；
- 全连接队列（Accpet 队列）：已完成 TCP 三次握手过程，处于 ESTABLISHED 状态；

![ SYN 队列 与 Accpet 队列 ](../../../assets/图解网络-小林coding/13-tcp_interview/img-048.png)
...
![socket 三次握手](../../../assets/图解网络-小林coding/13-tcp_interview/img-049.png)

- 客户端的协议栈向服务端发送了 SYN 包，并告诉服务端当前发送序列号 client\_isn，客户端进入 SYN\_SENT 状态；
- 服务端的协议栈收到这个包之后，和客户端进行 ACK 应答，应答的值为 client\_isn+1，表示对 SYN 包 client\_isn 的确认，同时服务端也发送一个 SYN 包，告诉客户端当前我的发送序列号为 server\_isn，服务端进入 SYN\_RCVD 状态；
- 客户端协议栈收到 ACK 之后，使得应用程序从 `connect` 调用返回，表示客户端到服务端的单向连接建立成功，客户端的状态为 ESTABLISHED，同时客户端协议栈也会对服务端的 SYN 包进行应答，应答数据为 server\_isn+1；
...
![客户端调用 close 过程](../../../assets/图解网络-小林coding/13-tcp_interview/img-050.png)

- 客户端调用 `close` ，表明客户端没有数据需要发送了，则此时会向服务端发送 FIN 报文，进入 FIN\_WAIT\_1 状态；
- 服务端接收到了 FIN 报文，TCP 协议栈会为 FIN 包插入一个文件结束符 `EOF` 到接收缓冲区中，应用程序可以通过 `read` 调用来感知这个 FIN 包。这个 `EOF` 会被 **放在已排队等候的其他已接收的数据之后** ，这就意味着服务端需要处理这种异常情况，因为 EOF 表示在该连接上再无额外数据到达。此时，服务端进入 CLOSE\_WAIT 状态；
...
![半连接队列与全连接队列](../../../assets/图解网络-小林coding/13-tcp_interview/img-051.png)
...
> [!info] 原文信息
> 原文：[4.2 TCP 重传、滑动窗口、流量控制、拥塞控制](https://xiaolincoding.com/network/3_tcp/tcp_feature.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/14-tcp_feature/img-001.png)
...
![正常的数据传输](../../../assets/图解网络-小林coding/14-tcp_feature/img-002.png)
...
![超时重传的两种情况](../../../assets/图解网络-小林coding/14-tcp_feature/img-003.png)

> 超时时间应该设置为多少呢？

我们先来了解一下什么是 `RTT` （Round-Trip Time 往返时延），从下图我们就可以知道：

![RTT](../../../assets/图解网络-小林coding/14-tcp_feature/img-004.jpg)
...
![超时时间较长与较短](../../../assets/图解网络-小林coding/14-tcp_feature/img-005.png)
...
![RTO 应略大于 RTT](../../../assets/图解网络-小林coding/14-tcp_feature/img-006.png)
...
![RFC6289 建议的 RTO 计算 ](../../../assets/图解网络-小林coding/14-tcp_feature/img-007.png)
...
![快速重传机制](../../../assets/图解网络-小林coding/14-tcp_feature/img-008.png)
...
![选择性确认](../../../assets/图解网络-小林coding/14-tcp_feature/img-009.png)
...
![ACK 丢包](../../../assets/图解网络-小林coding/14-tcp_feature/img-010.png)
...
![网络延时](../../../assets/图解网络-小林coding/14-tcp_feature/img-011.png)
...
![按数据包进行确认应答](../../../assets/图解网络-小林coding/14-tcp_feature/img-012.png)
...
![用滑动窗口方式并行处理](../../../assets/图解网络-小林coding/14-tcp_feature/img-013.png)
...
![](../../../assets/图解网络-小林coding/14-tcp_feature/img-014.png)
...
![可用窗口耗尽](../../../assets/图解网络-小林coding/14-tcp_feature/img-015.png)

在下图，当收到之前发送的数据 `32~36` 字节的 ACK 确认应答后，如果发送窗口的大小没有变化，则 **滑动窗口往右边移动 5 个字节，因为有 5 个字节的数据被应答确认** ，接下来 `52~56` 字节又变成了可用窗口，那么后续也就可以发送 `52~56` 这 5 个字节的数据了。

![32 ~ 36 字节已确认](../../../assets/图解网络-小林coding/14-tcp_feature/img-016.png)

> 程序是如何表示发送方的四个部分的呢？

TCP 滑动窗口方案使用三个指针来跟踪在四个传输类别中的每一个类别中的字节。其中两个指针是绝对指针（指特定的序列号），一个是相对指针（需要做偏移）。

![SND.WND、SND.UN、SND.NXT](../../../assets/图解网络-小林coding/14-tcp_feature/img-017.png)
...
![接收窗口](../../../assets/图解网络-小林coding/14-tcp_feature/img-018.jpg)
...
![流量控制](../../../assets/图解网络-小林coding/14-tcp_feature/img-019.png)
...
![](../../../assets/图解网络-小林coding/14-tcp_feature/img-020.png)
...
![](../../../assets/图解网络-小林coding/14-tcp_feature/img-021.png)
...
![窗口关闭潜在的危险](../../../assets/图解网络-小林coding/14-tcp_feature/img-022.png)
...
![窗口探测](../../../assets/图解网络-小林coding/14-tcp_feature/img-023.png)
...
![糊涂窗口综合症](../../../assets/图解网络-小林coding/14-tcp_feature/img-024.png)
...
![慢启动算法](../../../assets/图解网络-小林coding/14-tcp_feature/img-025.png)
...
![拥塞避免](../../../assets/图解网络-小林coding/14-tcp_feature/img-026.png)
...
![](../../../assets/图解网络-小林coding/14-tcp_feature/img-027.png)

拥塞发生算法的变化如下图：

![拥塞发送 —— 超时重传](../../../assets/图解网络-小林coding/14-tcp_feature/img-028.png)
...
![快速重传和快速恢复](../../../assets/图解网络-小林coding/14-tcp_feature/img-029.png)
...
> [!info] 原文信息
> 原文：[4.3 TCP 实战抓包分析](https://xiaolincoding.com/network/3_tcp/tcp_tcpdump.html)
> 提取：Defuddle 0.19.2
...
![提纲](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-001.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-002.png)

要抓取上面的 ping 命令数据包，首先我们要知道 ping 的数据包是 `icmp` 协议，接着在使用 tcpdump 抓包的时候，就可以指定只抓 icmp 协议的数据包：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-003.png)

那么当 tcpdump 抓取到 icmp 数据包后， 输出格式如下：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-004.png)

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-005.png)
...
![tcpdump 常用选项类](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-006.png)
...
![tcpdump 常用过滤表达式类](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-007.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-008.png)

接着把 ping.pcap 文件拖到电脑，再用 Wireshark 打开它。打开后，你就可以看到下面这个界面：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-009.png)
...
![ping 网络包](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-010.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-011.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-012.png)

接着，在终端二执行下面的 curl 命令：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-013.png)

最后，回到终端一，按下 Ctrl+C 停止 tcpdump，并把得到的 http.pcap 取出到电脑。

使用 Wireshark 打开 http.pcap 后，你就可以在 Wireshark 中，看到如下的界面：

![HTTP 网络包](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-014.png)
...
![TCP 流量图](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-015.png)
...
![取消序列号相对值显示](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-016.png)

取消后，Seq 显示的就是真实值了：

![TCP 流量图](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-017.png)

可见，客户端和服务端的序列号实际上是不同的，序列号是一个随机值。

这其实跟我们书上看到的 TCP 三次握手和四次挥手很类似，作为对比，你通常看到的 TCP 三次握手和四次挥手的流程，基本是这样的：

![TCP 三次握手和四次挥手的流程](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-018.png)
...
![实验环境](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-019.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-020.png)

其间 tcpdump 抓包的命令如下：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-021.png)

过了一会， curl 返回了超时连接的错误：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-022.png)

从 `date` 返回的时间，可以发现在超时接近 1 分钟的时间后，curl 返回了错误。

接着，把 tcp\_sys\_timeout.pcap 文件用 Wireshark 打开分析，显示如下图：

![SYN 超时重传五次](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-023.png)
...
![SYN 超时重传两次](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-024.png)
...
![SYN 超时重传](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-025.png)

#### 实验二：TCP 第二次握手 SYN、ACK 丢包

为了模拟客户端收不到服务端第二次握手 SYN、ACK 包，我的做法是在客户端加上防火墙限制，直接粗暴的把来自服务端的数据都丢弃，防火墙的配置如下：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-026.png)

接着，在客户端执行 curl 命令：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-027.png)

从 `date` 返回的时间前后，可以算出大概 1 分钟后，curl 报错退出了。

客户端在这其间抓取的数据包，用 Wireshark 打开分析，显示的时序图如下：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-028.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-029.png)
...
接着，我把 **tcp\_synack\_retries 设置为 2** ， `tcp_syn_retries` 依然设置为 1:
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-030.png)
...
客户端 SYN 包超时重传的最大次数，是由 tcp\_syn\_retries 决定的，默认值是 5 次；服务端 SYN、ACK 包时重传的最大次数，是由 tcp\_synack\_retries 决定的，默认值是 5 次。
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-031.png)

接着，在客户端执行如下 tcpdump 命令：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-032.png)

然后，客户端向服务端发起 telnet，因为 telnet 命令是会发起 TCP 连接，所以用此命令做测试：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-033.png)

此时，由于服务端收不到第三次握手的 ACK 包，所以一直处于 `SYN_RECV` 状态：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-034.png)

而客户端是已完成 TCP 连接建立，处于 `ESTABLISHED` 状态：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-035.png)

过了 1 分钟后，观察发现服务端的 TCP 连接不见了：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-036.png)

过了 30 分钟，客户端依然还是处于 `ESTABLISHED` 状态：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-037.png)

接着，在刚才客户端建立的 telnet 会话，输入 123456 字符，进行发送：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-038.png)

持续「好长」一段时间，客户端的 telnet 才断开连接：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-039.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-040.png)
...
> TCP 第一次握手的 SYN 包超时重传最大次数是由 tcp\_syn\_retries 指定，TCP 第二次握手的 SYN、ACK 包超时重传最大次数是由 tcp\_synack\_retries 指定，那 TCP 建立连接后的数据包最大超时重传次数是由什么参数指定呢？
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-041.png)
...
![常规 HTTP 请求](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-042.png)

在 Linux 3.7 内核版本中，提供了 TCP Fast Open 功能，这个功能可以减少 TCP 连接建立的时延。

![常规 HTTP 请求 与 Fast  Open HTTP 请求](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-043.png)
...
![TCP Fast Open 抓包分析](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-044.png)
...
![快速重传机制](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-045.png)

TCP 重复确认和快速重传的一个案例，用 Wireshark 分析，显示如下：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-046.png)
...
![理想状态下的窗口变化](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-047.png)
...
![服务端繁忙状态下的窗口变化](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-048.png)
...
![窗口大小在收缩](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-049.png)

接着，发送方会 **定时发送窗口大小探测报文** ，以便及时知道接收方窗口大小的变化。

以下图 Wireshark 分析图作为例子说明：

![零窗口 与 窗口探测](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-050.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-051.png)
...
![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-052.png)
...
![禁用 Nagle 算法 与 启用 Nagle 算法](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-053.png)
...
![关闭 Nagle 算法](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-054.png)
...
![TCP 延迟确认](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-055.png)

延迟等待的时间是在 Linux 内核中定义的，如下图：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-056.png)

关键就需要 `HZ` 这个数值大小，HZ 是跟系统的时钟频率有关，每个操作系统都不一样，在我的 Linux 系统中 HZ 大小是 `1000` ，如下图：

![](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-057.png)
...
![关闭 TCP 延迟确认](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-058.png)

> 延迟确认 和 Nagle 算法混合使用时，会产生新的问题

当 TCP 延迟确认 和 Nagle 算法混合使用时，会导致时耗增长，如下图：

![TCP 延迟确认 和 Nagle 算法混合使用](../../../assets/图解网络-小林coding/15-tcp_tcpdump/img-059.png)
...
> [!info] 原文信息
> 原文：[4.5 如何优化 TCP?](https://xiaolincoding.com/network/3_tcp/tcp_optimize.html)
> 提取：Defuddle 0.19.2
...
![Linux TCP 参数](../../../assets/图解网络-小林coding/17-tcp_optimize/img-001.png)
...
![本节提纲](../../../assets/图解网络-小林coding/17-tcp_optimize/img-002.png)
...
![三次握手与数据传输](../../../assets/图解网络-小林coding/17-tcp_optimize/img-003.png)
...
![TCP 三次握手的状态变迁](../../../assets/图解网络-小林coding/17-tcp_optimize/img-004.png)
...
![TCP 头部](../../../assets/图解网络-小林coding/17-tcp_optimize/img-005.png)

> SYN\_SENT 状态的优化

客户端作为主动发起连接方，首先它将发送 SYN 包，于是客户端的连接就会处于 `SYN_SENT` 状态。

客户端在等待服务端回复的 ACK 报文，正常情况下，服务器会在几毫秒内返回 SYN+ACK ，但如果客户端长时间没有收到 SYN+ACK 报文，则会重发 SYN 包， **重发的次数由 tcp\_syn\_retries 参数控制** ，默认是 5 次：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-006.png)
...
![SYN 超时重传](../../../assets/图解网络-小林coding/17-tcp_optimize/img-007.png)
...
![半连接队列与全连接队列](../../../assets/图解网络-小林coding/17-tcp_optimize/img-008.png)
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-009.png)
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-010.png)

增大 backlog 的方式，每个 Web 服务都不同，比如 Nginx 增大 backlog 的方法如下：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-011.png)
...
![开启 syncookies 功能](../../../assets/图解网络-小林coding/17-tcp_optimize/img-012.png)
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-013.png)
...
当网络繁忙、不稳定时，报文丢失就会变严重，此时应该调大重发次数。反之则可以调小重发次数。 **修改重发次数的方法是，调整 tcp\_synack\_retries 参数** ：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-014.png)

tcp\_synack\_retries 的默认重试次数是 5 次，与客户端重传 SYN 类似，它的重传会经历 1、2、4、8、16 秒，最后一次重传后会继续等待 32 秒，如果服务端仍然没有收到 ACK，才会关闭连接，故共需要等待 63 秒。
...
![ accept 队列溢出](../../../assets/图解网络-小林coding/17-tcp_optimize/img-015.png)

> accept 队列已满，只能丢弃连接吗？

丢弃连接只是 Linux 的默认行为，我们还可以选择向客户端发送 RST 复位报文，告诉客户端连接已经建立失败。打开这一功能需要将 tcp\_abort\_on\_overflow 参数设置为 1。

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-016.png)
...
![tcp_abort_on_overflow 为 0 可以应对突发流量](../../../assets/图解网络-小林coding/17-tcp_optimize/img-017.png)
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-018.png)
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-019.png)
...
![常规 HTTP 请求](../../../assets/图解网络-小林coding/17-tcp_optimize/img-020.png)

在 Linux 3.7 内核版本之后，提供了 TCP Fast Open 功能，这个功能可以减少 TCP 连接建立的时延。

> 接下来说说，TCP Fast Open 功能的工作方式。

![开启 TCP Fast Open 功能](../../../assets/图解网络-小林coding/17-tcp_optimize/img-021.png)
...
![TCP option 字段 - TFO](../../../assets/图解网络-小林coding/17-tcp_optimize/img-022.png)

注：客户端在请求并存储了 Fast Open Cookie 之后，可以不断重复 TCP Fast Open 直至服务器认为 Cookie 无效（通常为过期）。

> Linux 下怎么打开 TCP Fast Open 功能呢？

在 Linux 系统中，可以通过 **设置 tcp\_fastopn 内核参数，来打开 Fast Open 功能** ：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-023.png)
...
![三次握手优化策略](../../../assets/图解网络-小林coding/17-tcp_optimize/img-024.png)
...
服务端收到客户端返回的 ACK，会把连接移入 accept 队列，等待进行调用 accept() 函数取出连接。

可以通过 `ss -lnt` 查看服务端进程的 accept 队列长度，如果 accept 队列溢出，系统默认丢弃 ACK，如果可以把 `tcp_abort_on_overflow` 设置为 1 ，表示用 RST 通知客户端连接建立失败。

如果 accept 队列溢出严重，可以通过 listen 函数的 `backlog` 参数和 `somaxconn` 系统参数提高队列大小，accept 队列长度取决于 min(backlog, somaxconn)。
...
![客户端主动关闭](../../../assets/图解网络-小林coding/17-tcp_optimize/img-025.png)
...
- 当主动方收到这个 FIN 报文后，内核会回复 ACK 报文给被动方，同时主动方的连接状态由 FIN\_WAIT2 变为 TIME\_WAIT， **在 Linux 系统下大约等待 1 分钟后，TIME\_WAIT 状态的连接才会彻底关闭** 。
...
安全关闭连接的方式必须通过四次挥手，它由进程调用 `close` 和 `shutdown` 函数发起 FIN 报文（shutdown 参数须传入 SHUT\_WR 或者 SHUT\_RDWR 才会发送 FIN）。
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-026.png)

第二个参数决定断开连接的方式，主要有以下三种方式：

- SHUT\_RD(0)： **关闭连接的「读」这个方向** ，如果接收缓冲区有已接收的数据，则将会被丢弃，并且后续再收到新的数据，会对数据进行 ACK，然后悄悄地丢弃。也就是说，对端还是会接收到 ACK，在这种情况下根本不知道数据已经被丢弃了。
- SHUT\_WR(1)： **关闭连接的「写」这个方向** ，这就是常被称为「半关闭」的连接。如果发送缓冲区还有未发送的数据，将被立即发送出去，并发送一个 FIN 报文给对端。
- SHUT\_RDWR(2)：相当于 SHUT\_RD 和 SHUT\_WR 操作各一次， **关闭套接字的读和写两个方向** 。
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-027.png)

你可能会好奇，这 0 表示几次？ **实际上当为 0 时，特指 8 次** ，从下面的内核源码可知：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-028.png)
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-029.png)
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-030.png)

它意味着对于孤儿连接（调用 close 关闭的连接），如果在 60 秒后还没有收到 FIN 报文，连接就会直接关闭。

这个 60 秒不是随便决定的，它与 TIME\_WAIT 状态持续的时间是相同的，后面我们再来说说为什么是 60 秒。
...
TIME\_WAIT 状态的连接，在主动方看来确实快已经关闭了。然后，被动方没有收到 ACK 报文前，还是处于 LAST\_ACK 状态。如果这个 ACK 报文没有到达被动方，被动方就会重发 FIN 报文。重发次数仍然由前面介绍过的 tcp\_orphan\_retries 参数控制。
...
![TIME-WAIT 时间过短，收到旧连接的数据报文](../../../assets/图解网络-小林coding/17-tcp_optimize/img-031.png)
...
假设客户端没有 TIME\_WAIT 状态，而是在发完最后一次回 ACK 报文就直接进入 CLOSED 状态，如果该 ACK 报文丢失了，服务端则重传的 FIN 报文，而这时客户端已经进入到关闭状态了，在收到服务端重传的 FIN 报文后，就会回 RST 报文。

![TIME-WAIT 时间过短，没有确保连接正常关闭](../../../assets/图解网络-小林coding/17-tcp_optimize/img-032.png)

服务端收到这个 RST 并将其解释为一个错误（Connection reset by peer），这对于一个可靠的协议来说不是一个优雅的终止方式。

为了防止这种情况出现，客户端必须等待足够长的时间，确保服务端能够收到 ACK，如果服务端没有收到 ACK，那么就会触发 TCP 重传机制，服务端会重新发送一个 FIN，这样一去一来刚好两个 MSL 的时间。

![TIME-WAIT 时间正常，确保了连接正常关闭](../../../assets/图解网络-小林coding/17-tcp_optimize/img-033.png)

客户端在收到服务端重传的 FIN 报文时，TIME\_WAIT 状态的等待时间，会重置回 2MSL。

我们再回过头来看看，为什么 TIME\_WAIT 状态要保持 60 秒呢？

这与孤儿连接 FIN\_WAIT2 状态默认保留 60 秒的原理是一样的， **因为这两个状态都需要保持 2MSL 时长。MSL 全称是 Maximum Segment Lifetime，它定义了一个报文在网络中的最长生存时间** （报文每经过一次路由器的转发，IP 头部的 TTL 字段就会减 1，减到 0 时报文就被丢弃，这就限制了报文的最长存活时间）。
...
**Linux 提供了 tcp\_max\_tw\_buckets 参数，当 TIME\_WAIT 的连接数量超过该参数时，新关闭的连接就不再经历 TIME\_WAIT 而直接关闭：**

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-034.png)

当服务器的并发连接增多时，相应地，同时处于 TIME\_WAIT 状态的连接数量也会变多，此时就应当调大 `tcp_max_tw_buckets` 参数，减少不同连接间数据错乱的概率。tcp\_max\_tw\_buckets 也不是越大越好，毕竟系统资源是有限的。

> TIME\_WAIT 状态优化方式二

**有一种方式可以在建立新连接时，复用处于 TIME\_WAIT 状态的连接，那就是打开 tcp\_tw\_reuse 参数。但是需要注意，该参数是只用于客户端（建立连接的发起方），因为是在调用 connect() 时起作用的，而对于服务端（被动连接方）是没有用的。**

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-035.png)

网上很多博客都说在服务端开启 tcp\_tw\_reuse 参数来优化 TCP，我信你个鬼，糟老头坏的很！ **tcp\_tw\_reuse 只作用在 connect 函数，也就是客户端，跟服务端一毛关系的没有** 。

tcp\_tw\_reuse 从协议角度理解是安全可控的，可以复用处于 TIME\_WAIT 的端口为新的连接所用。
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-036.png)

由于引入了时间戳，它能带来了些好处：

- 我们在前面提到的 2MSL（TIME\_WAIT状态的持续时间） 问题就不复存在了，因为重复的数据包会因为时间戳过期被自然丢弃；
- 同时，它还可以防止序列号绕回，也是因为重复的数据包会由于时间戳过期被自然丢弃；

时间戳是在 TCP 的选项字段里定义的，开启了时间戳功能，在 TCP 报文传输的时候会带上发送报文的时间戳。

![TCP option 字段 - 时间戳](../../../assets/图解网络-小林coding/17-tcp_optimize/img-037.png)

另外，老版本的 Linux 还提供了 `tcp_tw_recycle` 参数，但是当开启了它，允许处于 TIME\_WAIT 状态的连接被快速回收，但是有个 **大坑** 。
...
因此，tcp\_tw\_recycle 在使用了 NAT 的网络下是存在问题的，如果它是对 TCP 四元组做 PAWS 检查，而不是对「相同的 IP 做 PAWS 检查」，那么就不会存在这个问题了。

网上很多博客都说开启 tcp\_tw\_recycle 参数来优化 TCP，我信你个鬼，糟老头坏的很！

所以，不建议设置为 1 ，在 Linux 4.12 版本后，Linux 内核直接取消了这一参数，建议关闭它：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-038.png)

> TIME\_WAIT 状态优化方式三

我们可以在程序中设置 socket 选项，来设置调用 close 关闭连接行为。

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-039.png)

如果 `l_onoff` 为非 0， 且 `l_linger` 值为 0， **那么调用 close 后，会立该发送一个 RST 标志给对端，该 TCP 连接将跳过四次挥手，也就跳过了 TIME\_WAIT 状态，直接关闭。**

这种方式只推荐在客户端使用，服务端千万不要使用。因为服务端一调用 close，就发送 RST 报文的话，客户端就总是看到 TCP 连接错误 “connnection reset by peer”。

#### 被动方的优化

当被动方收到 FIN 报文时，内核会自动回复 ACK，同时连接处于 CLOSE\_WAIT 状态，顾名思义，它表示等待应用进程调用 close 函数关闭连接。

内核没有权利替代进程去关闭连接，因为如果主动方是通过 shutdown 关闭连接，那么它就是想在半关闭连接上接收数据或发送数据。因此，Linux 并没有限制 CLOSE\_WAIT 状态的持续时间。

当然，大多数应用程序并不使用 shutdown 函数关闭连接。所以， **当你用 netstat 命令发现大量 CLOSE\_WAIT 状态。就需要排查你的应用程序，因为可能因为应用程序出现了 Bug，read 函数返回 0 时，没有调用 close 函数。**
...
![同时关闭](../../../assets/图解网络-小林coding/17-tcp_optimize/img-040.png)
...
![四次挥手的优化策略](../../../assets/图解网络-小林coding/17-tcp_optimize/img-041.png)

> 主动方的优化

主动发起 FIN 报文断开连接的一方，如果迟迟没收到对方的 ACK 回复，则会重传 FIN 报文，重传的次数由 `tcp_orphan_retries` 参数决定。

当主动方收到 ACK 报文后，连接就进入 FIN\_WAIT2 状态，根据关闭的方式不同，优化的方式也不同：
...
![按数据包进行确认应答](../../../assets/图解网络-小林coding/17-tcp_optimize/img-042.png)

所以，这样的传输方式有一个缺点：数据包的 **往返时间越长，通信的效率就越低** 。

**要解决这一问题不难，并行批量发送报文，再批量确认报文即可。**

![并行处理](../../../assets/图解网络-小林coding/17-tcp_optimize/img-043.png)
...
![TCP 头部](../../../assets/图解网络-小林coding/17-tcp_optimize/img-044.png)
...
![TCP option 选项 - 窗口扩展](../../../assets/图解网络-小林coding/17-tcp_optimize/img-045.png)

Linux 中打开这一功能，需要把 tcp\_window\_scaling 配置设为 1（默认打开）：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-046.png)
...
![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-047.png)
...
先来看看发送缓冲区，它的范围通过 tcp\_wmem 参数配置；

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-048.png)
...
而接收缓冲区的调整就比较复杂一些，先来看看设置接收缓冲区范围的 tcp\_rmem 参数：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-049.png)
...
发送缓冲区的调节功能是自动开启的， **而接收缓冲区则需要配置 tcp\_moderate\_rcvbuf 为 1 来开启调节功能** ：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-050.png)

> 调节 TCP 内存范围

接收缓冲区调节时，怎么知道当前内存是否紧张或充分呢？这是通过 tcp\_mem 配置完成的：

![](../../../assets/图解网络-小林coding/17-tcp_optimize/img-051.png)
...
一般情况下这些值是在系统启动时根据系统内存数量计算得到的。根据当前 tcp\_mem 最大内存页面数是 177120，当内存为 (177120 \* 4) / 1024K ≈ 692M 时，系统将无法为新的 TCP 连接分配内存，即 TCP 连接将被拒绝。
...
![数据传输的优化策略](../../../assets/图解网络-小林coding/17-tcp_optimize/img-052.png)
...
> [!info] 原文信息
> 原文：[4.6 如何理解是 TCP 面向字节流协议？](https://xiaolincoding.com/network/3_tcp/tcp_stream.html)
> 提取：Defuddle 0.19.2
...
![图片](../../../assets/图解网络-小林coding/18-tcp_stream/img-001.png)
...
![图片](../../../assets/图解网络-小林coding/18-tcp_stream/img-002.png)

第二种情况，「I am Xiaolin」的部分随 「Hi」 在一个 TCP 报文中发送出去，像这样：

![图片](../../../assets/图解网络-小林coding/18-tcp_stream/img-003.png)

第三种情况，「Hi.」 的一部分随 TCP 报文被发送出去，另一部分和 「I am Xiaolin」 一起随另一个 TCP 报文发送出去，像这样。

![图片](../../../assets/图解网络-小林coding/18-tcp_stream/img-004.png)
...
![图片](../../../assets/图解网络-小林coding/18-tcp_stream/img-005.png)
...
> [!info] 原文信息
> 原文：[4.7 为什么 TCP 每次建立连接时，初始化序列号都要不一样呢？](https://xiaolincoding.com/network/3_tcp/isn_deff.html)
> 提取：Defuddle 0.19.2
...
> TCP 四次挥手中的 TIME\_WAIT 状态不是会持续 2 MSL 时长，历史报文不是早就在网络中消失了吗？

是的，如果能正常四次挥手，由于 TIME\_WAIT 状态会持续 2 MSL 时长，历史报文会在下一个连接之前就会自然消失。

但是来了，我们并不能保证每次连接都能通过四次挥手来正常关闭连接。

假设每次建立连接，客户端和服务端的初始化序列号都是从 0 开始：

![](../../../assets/图解网络-小林coding/19-isn_deff/img-001.png)
...
![isn不同](../../../assets/图解网络-小林coding/19-isn_deff/img-002.png)
...
![](../../../assets/图解网络-小林coding/19-isn_deff/img-003.png)

通过前面我们知道， **序列号和初始化序列号并不是无限递增的，会发生回绕为初始值的情况，这意味着无法根据序列号来判断新老数据** 。

不要以为序列号的上限值是 4GB，就以为很大，很难发生回绕。在一个速度足够快的网络中传输大量数据时，序列号的回绕时间就会变短。如果序列号回绕的时间极短，我们就会再次面临之前延迟的报文抵达后序列号依然有效的问题。

为了解决这个问题，就需要有 TCP 时间戳。tcp\_timestamps 参数是默认开启的，开启了 tcp\_timestamps 参数，TCP 头部就会使用时间戳选项，它有两个好处， **一个是便于精确计算 RTT ，另一个是能防止序列号回绕（PAWS）** 。

试看下面的示例，假设 TCP 的发送窗口是 1 GB，并且使用了时间戳选项，发送方会为每个 TCP 报文分配时间戳数值，我们假设每个报文时间加 1，然后使用这个连接传输一个 6GB 大小的数据流。

![图片](../../../assets/图解网络-小林coding/19-isn_deff/img-004.png)
...
> [!info] 原文信息
> 原文：[4.8 SYN 报文什么情况下会被丢弃？](https://xiaolincoding.com/network/3_tcp/syn_drop.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/20-syn_drop/img-001.jpg)
...
- 开启 tcp\_tw\_recycle 参数，并且在 NAT 环境下，造成 SYN 报文被丢弃
- TCP 两个队列满了（半连接队列和全连接队列），造成 SYN 报文被丢弃

### 坑爹的 tcp\_tw\_recycle

TCP 四次挥手过程中，主动断开连接方会有一个 TIME\_WAIT 的状态，这个状态会持续 2 MSL 后才会转变为 CLOSED 状态。

![](../../../assets/图解网络-小林coding/20-syn_drop/img-002.png)

在 Linux 操作系统下，TIME\_WAIT 状态的持续时间是 60 秒，这意味着这 60 秒内，客户端一直会占用着这个端口。要知道，端口资源也是有限的，一般可以开启的端口为 32768~61000 ，也可以通过如下参数设置指定范围：

```
net.ipv4.ip_local_port_range
```

**如果客户端（发起连接方）的 TIME\_WAIT 状态过多** ，占满了所有端口资源，那么就无法对「目的 IP+ 目的 PORT」都一样的服务器发起连接了，但是被使用的端口，还是可以继续对另外一个服务器发起连接的。具体可以看我这篇文章： [客户端的端口可以重复使用吗？](https://xiaolincoding.com/network/3_tcp/port.html#%E5%AE%A2%E6%88%B7%E7%AB%AF%E7%9A%84%E7%AB%AF%E5%8F%A3%E5%8F%AF%E4%BB%A5%E9%87%8D%E5%A4%8D%E4%BD%BF%E7%94%A8%E5%90%97)

因此，客户端（发起连接方）都是和「目的 IP+ 目的 PORT 」都一样的服务器建立连接的话，当客户端的 TIME\_WAIT 状态连接过多的话，就会受端口资源限制，如果占满了所有端口资源，那么就无法再跟「目的 IP+ 目的 PORT」都一样的服务器建立连接了。
...
但是 TIME\_WAIT 状态也不是摆设作用，它的作用有两个：

- 防止具有相同四元组的旧数据包被收到，也就是防止历史连接中的数据，被后面的连接接受，否则就会导致后面的连接收到一个无效的数据，
- 保证「被动关闭连接」的一方能被正确的关闭，即保证最后的 ACK 能让被动关闭方接收，从而帮助其正常关闭;

不过，Linux 操作系统提供了两个可以系统参数来快速回收处于 TIME\_WAIT 状态的连接，这两个参数都是默认关闭的：

- net.ipv4.tcp\_tw\_reuse，如果开启该选项的话，客户端（连接发起方） 在调用 connect() 函数时，\*\*如果内核选择到的端口，已经被相同四元组的连接占用的时候，就会判断该连接是否处于 TIME\_WAIT 状态，如果该连接处于 TIME\_WAIT 状态并且 TIME\_WAIT 状态持续的时间超过了 1 秒，那么就会重用这个连接，然后就可以正常使用该端口了。\*\*所以该选项只适用于连接发起方。
- net.ipv4.tcp\_tw\_recycle，如果开启该选项的话，允许处于 TIME\_WAIT 状态的连接被快速回收；

要使得这两个选项生效，有一个前提条件，就是要打开 TCP 时间戳，即 net.ipv4.tcp\_timestamps=1（默认即为 1)）。

**tcp\_tw\_recycle 在使用了 NAT 的网络下是不安全的！**

对于服务器来说，如果同时开启了recycle 和 timestamps 选项，则会开启一种称之为「 per-host 的 PAWS 机制」。

> 首先给大家说说什么是 PAWS 机制？

tcp\_timestamps 选项开启之后， PAWS 机制会自动开启，它的作用是防止 TCP 包中的序列号发生绕回。
...
![](../../../assets/图解网络-小林coding/20-syn_drop/img-003.png)
...
PAWS 就是为了避免这个问题而产生的，在开启 tcp\_timestamps 选项情况下，一台机器发的所有 TCP 包都会带上发送时的时间戳，PAWS 要求连接双方维护最近一次收到的数据包的时间戳（Recent TSval），每收到一个新数据包都会读取数据包中的时间戳值跟 Recent TSval 值做比较， **如果发现收到的数据包中时间戳不是递增的，则表示该数据包是过期的，就会直接丢弃这个数据包** 。
...
tcp\_tw\_recycle 在 Linux 4.12 版本后，直接取消了这一参数。
...
![](../../../assets/图解网络-小林coding/20-syn_drop/img-004.png)
...
![](../../../assets/图解网络-小林coding/20-syn_drop/img-005.png)
...
![](../../../assets/图解网络-小林coding/20-syn_drop/img-006.png)
...
**要想增大半连接队列，我们得知不能只单纯增大 tcp\_max\_syn\_backlog 的值，还需一同增大 somaxconn 和 backlog，也就是增大全连接队列** 。否则，只单纯增大 tcp\_max\_syn\_backlog 是无效的。

增大 tcp\_max\_syn\_backlog 和 somaxconn 的方法是修改 Linux 内核参数：

![](../../../assets/图解网络-小林coding/20-syn_drop/img-007.png)

增大 backlog 的方式，每个 Web 服务都不同，比如 Nginx 增大 backlog 的方法如下：

![](../../../assets/图解网络-小林coding/20-syn_drop/img-008.png)
...
![](../../../assets/图解网络-小林coding/20-syn_drop/img-009.png)
...
- 调大 accept 队列的最大长度，调大的方式是通过 **调大 backlog 以及 somaxconn 参数。**
- 检查系统或者代码为什么调用 accept() 不及时；

关于 SYN 队列和 accept 队列，我之前写过一篇很详细的文章： [TCP 半连接队列和全连接队列满了会发生什么？又该如何应对？](https://mp.weixin.qq.com/s/2qN0ulyBtO2I67NB_RnJbg)
...
> [!info] 原文信息
> 原文：[4.10 四次挥手中收到乱序的 FIN 包会如何处理？](https://xiaolincoding.com/network/3_tcp/out_of_order_fin.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-001.jpg)

不得不说，鹅厂真的很喜欢问网络问题，而且爱问异常情况下的网络问题。

不过这道鹅厂的网络题可能是提问的读者表述有问题， **因为如果 FIN 报文比数据包先抵达客户端，此时 FIN 报文其实是一个乱序的报文，此时客户端的 TCP 连接并不会从 FIN\_WAIT\_2 状态转换到 TIME\_WAIT 状态** 。

![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-002.png)

因此，我们要关注到点是看「 **在 FIN\_WAIT\_2 状态下，是如何处理收到的乱序到 FIN 报文，然后 TCP 连接又是什么时候才进入到 TIME\_WAIT 状态?**」。
...
![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-003.png)
...
这次我们重点分析的是，在 FIN\_WAIT\_2 状态下，收到 FIN 报文是如何处理的。

在 Linux 内核里，当 IP 层处理完消息后，会通过回调 tcp\_v4\_rcv 函数将消息转给 TCP 层，所以这个函数就是 TCP 层收到消息的入口。

![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-004.jpg) 处于 FIN\_WAIT\_2 状态下的客户端，在收到服务端的报文后，最终会调用 tcp\_v4\_do\_rcv 函数。

![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-005.jpg)

接下来，tcp\_v4\_do\_rcv 方法会调用 tcp\_rcv\_state\_process，在这里会根据 TCP 状态做对应的处理，这里我们只关注 FIN\_WAIT\_2 状态。

![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-006.jpg)

在上面这个代码里，可以看到如果 shutdown 关闭了读方向，那么在收到对方发来的数据包，则会回复 RST 报文。

而我们这次的题目里， shutdown 只关闭了写方向，所以会继续往下调用 tcp\_data\_queue 函数（因为 case TCP\_FIN\_WAIT2 代码块里并没有 break 语句，所以会走到该函数）。

![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-007.jpg) 在上面的 tcp\_data\_queue 函数里，如果收到的报文的序列号是我们预期的，也就是有序的话：

- 会判断该报文有没有 FIN 标志，如果有的话就会调用 tcp\_fin 函数，这个函数负责将 FIN\_WAIT\_2 状态转换为 TIME\_WAIT。
- 接着还会看乱序队列有没有数据，如果有的话会调用 tcp\_ofo\_queue 函数，这个函数负责检查乱序队列中是否有数据包可用，即能不能在乱序队列找到与当前数据包保持序列号连续的数据包。

而当收到的报文的序列号不是我们预期的，也就是乱序的话，则调用 tcp\_data\_queue\_ofo 函数，将报文加入到乱序队列，这个队列的数据结构是红黑树。

我们的题目里，客户端收到的 FIN 报文实际上是一个乱序的报文，因此此时并不会调用 tcp\_fin 函数进行状态转换，而是将报文通过 tcp\_data\_queue\_ofo 函数加入到乱序队列。

然后当客户端收到被网络延迟的数据包后，此时因为该数据包的序列号是期望的，然后又因为上一次收到的乱序 FIN 报文被加入到了乱序队列，表明乱序队列是有数据的，于是就会调用 tcp\_ofo\_queue 函数。

我们来看看 tcp\_ofo\_queue 函数。

![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-008.jpg)

在上面的 tcp\_ofo\_queue 函数里，在乱序队列中找到能与当前报文的序列号保持的顺序的报文后，会看该报文是否有 FIN 标志，如果有的话，就会调用 tcp\_fin() 函数。

最后，我们来看看 tcp\_fin 函数的处理。

![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-009.jpg)

可以看到，如果当前的 TCP 状态为 TCP\_FIN\_WAIT2，就会发送第四次挥手 ack，然后调用 tcp\_time\_wait 函数，这个函数里会将 TCP 状态变更为 TIME\_WAIT，并启动 TIME\_WAIT 的定时器。
...
![](../../../assets/图解网络-小林coding/22-out_of_order_fin/img-010.png)
...
> [!info] 原文信息
> 原文：[4.12 TCP 连接，一端断电和进程崩溃有什么区别？](https://xiaolincoding.com/network/3_tcp/tcp_down_and_crash.html)
> 提取：Defuddle 0.19.2

有位读者找我说，他在面试腾讯的时候，遇到了这么个问题：

![在这里插入图片描述](../../../assets/图解网络-小林coding/24-tcp_down_and_crash/img-001.png)

这个属于 **TCP 异常断开连接** 的场景，这部分内容在我的「图解网络」还没有详细介绍过，这次就乘着这次机会补一补。

![在这里插入图片描述](../../../assets/图解网络-小林coding/24-tcp_down_and_crash/img-002.png)
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/24-tcp_down_and_crash/img-003.png)
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/24-tcp_down_and_crash/img-004.png)
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/24-tcp_down_and_crash/img-005.png)
...
![](../../../assets/图解网络-小林coding/24-tcp_down_and_crash/img-006.png)

> 那 TCP 的数据报文具体重传几次呢？

在 Linux 系统中，提供一个叫 tcp\_retries2 配置项，默认值是 15，如下图：

![在这里插入图片描述](../../../assets/图解网络-小林coding/24-tcp_down_and_crash/img-007.png)
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/24-tcp_down_and_crash/img-008.png)
...
- 如果服务端会发送数据，由于客户端已经不存在，收不到数据报文的响应报文，服务端的数据报文会超时重传，当重传总间隔时长达到一定阈值（内核会根据 tcp\_retries2 设置的值计算出一个阈值）后，会断开 TCP 连接；
...
> [!info] 原文信息
> 原文：[4.13 拔掉网线后， 原本的 TCP 连接还存在吗？](https://xiaolincoding.com/network/3_tcp/tcp_unplug_the_network_cable.html)
> 提取：Defuddle 0.19.2
...
![图片](../../../assets/图解网络-小林coding/25-tcp_unplug_the_network_cable/img-001.png)
...
![图片](../../../assets/图解网络-小林coding/25-tcp_unplug_the_network_cable/img-002.png)
...
![](../../../assets/图解网络-小林coding/25-tcp_unplug_the_network_cable/img-003.png)
...
![](../../../assets/图解网络-小林coding/25-tcp_unplug_the_network_cable/img-004.png)
...
![图片](../../../assets/图解网络-小林coding/25-tcp_unplug_the_network_cable/img-005.png)
...
> [!info] 原文信息
> 原文：[4.14 tcptwreuse 为什么默认是关闭的？](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html)
> 提取：Defuddle 0.19.2
...
上周有个读者在面试微信的时候， **被问到既然打开 net.ipv4.tcp\_tw\_reuse 参数可以快速复用处于 TIME\_WAIT 状态的 TCP 连接，那为什么 Linux 默认是关闭状态呢？**

![图片](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-001.png)

好家伙，真的问好细节！

当时看到读者这个问题的时候，我也是一脸懵逼的，经过我的一番思考后，终于知道怎么回答这题了。

其实这题在变相问「 **如果 TIME\_WAIT 状态持续时间过短或者没有，会有什么问题？** 」

因为开启 tcp\_tw\_reuse 参数可以快速复用处于 TIME\_WAIT 状态的 TCP 连接时，相当于缩短了 TIME\_WAIT 状态的持续时间。

可能有的同学会问说，使用 tcp\_tw\_reuse 快速复用处于 TIME\_WAIT 状态的 TCP 连接时，是需要保证 net.ipv4.tcp\_timestamps 参数是开启的（默认是开启的），而 tcp\_timestamps 参数可以避免旧连接的延迟报文，这不是解决了没有 TIME\_WAIT 状态时的问题了吗？

是解决部分问题，但是不能完全解决，接下来，我跟大家聊聊这个问题。

![图片](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-002.png)

### 什么是 TIME\_WAIT 状态？

TCP 四次挥手过程，如下图：

![图片](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-003.png)
...
可以看到，TIME\_WAIT 是「主动关闭方」断开连接时的最后一个状态，该状态会持续 \* **2MSL(Maximum Segment Lifetime)\*** 时长，之后进入CLOSED 状态。
...
![图片](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-004.png)

通过前面我们知道， **序列号和初始化序列号并不是无限递增的，会发生回绕为初始值的情况，这意味着无法根据序列号来判断新老数据** 。

假设 TIME-WAIT 没有等待时间或时间过短，被延迟的数据包抵达后会发生什么呢？

![图片](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-005.png)
...
![图片](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-006.png)

服务端收到这个 RST 并将其解释为一个错误（Connection reset by peer），这对于一个可靠的协议来说不是一个优雅的终止方式。

为了防止这种情况出现，客户端必须等待足够长的时间，确保服务端能够收到 ACK，如果服务端没有收到 ACK，那么就会触发 TCP 重传机制，服务端会重新发送一个 FIN，这样一去一来刚好两个 MSL 的时间。

![TIME-WAIT 时间正常，确保了连接正常关闭](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-007.png)
...
**如果客户端（主动关闭连接方）的 TIME\_WAIT 状态过多** ，占满了所有端口资源，那么就无法对「目的 IP+ 目的 PORT」都一样的服务器发起连接了，但是被使用的端口，还是可以继续对另外一个服务器发起连接的。具体可以看我这篇文章： [客户端的端口可以重复使用吗？](https://xiaolincoding.com/network/3_tcp/port.html#%E5%AE%A2%E6%88%B7%E7%AB%AF%E7%9A%84%E7%AB%AF%E5%8F%A3%E5%8F%AF%E4%BB%A5%E9%87%8D%E5%A4%8D%E4%BD%BF%E7%94%A8%E5%90%97)

因此，客户端（主动关闭连接方）都是和「目的 IP+ 目的 PORT 」都一样的服务器建立连接的话，当客户端的 TIME\_WAIT 状态连接过多的话，就会受端口资源限制，如果占满了所有端口资源，那么就无法再跟「目的 IP+ 目的 PORT」都一样的服务器建立连接了。

不过，即使是在这种场景下，只要连接的是不同的服务器，端口是可以重复使用的，所以客户端还是可以向其他服务器发起连接的，这是因为内核在定位一个连接的时候，是通过四元组（源IP、源端口、目的IP、目的端口）信息来定位的，并不会因为客户端的端口一样，而导致连接冲突。

好在，Linux 操作系统提供了两个可以系统参数来快速回收处于 TIME\_WAIT 状态的连接，这两个参数都是默认关闭的：

- net.ipv4.tcp\_tw\_reuse，如果开启该选项的话，客户端（连接发起方） 在调用 connect() 函数时， **如果内核选择到的端口，已经被相同四元组的连接占用的时候，就会判断该连接是否处于 TIME\_WAIT 状态，如果该连接处于 TIME\_WAIT 状态并且 TIME\_WAIT 状态持续的时间超过了 1 秒，那么就会重用这个连接，然后就可以正常使用该端口了** 。所以该选项只适用于连接发起方。
- net.ipv4.tcp\_tw\_recycle，如果开启该选项的话，允许处于 TIME\_WAIT 状态的连接被快速回收，该参数在 **NAT 的网络下是不安全的** ！详细见这篇文章介绍： [SYN 报文什么时候情况下会被丢弃？](https://xiaolincoding.com/network/3_tcp/syn_drop.html)

要使得上面这两个参数生效，有一个前提条件，就是要打开 TCP 时间戳，即 net.ipv4.tcp\_timestamps=1（默认即为 1）。

开启了 tcp\_timestamps 参数，TCP 头部就会使用时间戳选项，它有两个好处， **一个是便于精确计算 RTT ，另一个是能防止序列号回绕（PAWS）** ，我们先来介绍这个功能。
...
![图片](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-008.png)
...
### 为什么 tcp\_tw\_reuse 默认是关闭的？

通过前面这么多铺垫，终于可以说这个问题了。

开启 tcp\_tw\_reuse 会有什么风险呢？我觉得会有 2 个问题。

#### 第一个问题

我们知道开启 tcp\_tw\_reuse 的同时，也需要开启 tcp\_timestamps，意味着可以用时间戳的方式有效的判断回绕序列号的历史报文。

但是，在看我看了防回绕序列号函数的源码后，发现对于 **RST 报文的时间戳即使过期了，只要 RST 报文的序列号在对方的接收窗口内，也是能被接受的** 。

下面 tcp\_validate\_incoming 函数就是验证接收到的 TCP 报文是否合格的函数，其中第一步就会进行 PAWS 检查，由 tcp\_paws\_discard 函数负责。
...
当 tcp\_paws\_discard 返回 true，就代表报文是一个历史报文，于是就要丢弃这个报文。但是在丢掉这个报文的时候，会先判断是不是 RST 报文，如果不是 RST 报文，才会将报文丢掉。也就是说，即使 RST 报文是一个历史报文，并不会被丢弃。

假设有这样的场景，如下图：

![](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-009.png)
...
- 因为 **客户端开启了 tcp\_tw\_reuse，于是快速复用 TIME\_WAIT 状态的端口，又与服务端建立了一个与刚才相同的四元组的连接** 。
- 接着， **前面被网络延迟 RST 报文这时抵达了客户端，而且 RST 报文的序列号在客户端的接收窗口内，由于防回绕序列号算法不会防止过期的 RST，所以 RST 报文会被客户端接受了，于是客户端的连接就断开了** 。

上面这个场景就是开启 tcp\_tw\_reuse 风险， **因为快速复用 TIME\_WAIT 状态的端口，导致新连接可能被回绕序列号的 RST 报文断开了，而如果不跳过 TIME\_WAIT 状态，而是停留 2MSL 时长，那么这个 RST 报文就不会出现下一个新的连接** 。
...
RFC 1323 提到说收历史的 RST 报文是极不可能，之所以有这样的想法是因为 TIME\_WAIT 状态持续的 2MSL 时间，足以让连接中的报文在网络中自然消失，所以认为按正常操作来说是不会发生的，因此认为清除连接优先于时间戳。

而我前面提到的案例，是因为开启了 tcp\_tw\_reuse 状态，跳过了 TIME\_WAIT 状态，才发生的事情。

有同学会说，都经过一个 HTTP 请求了，延迟的 RST 报文竟然还会存活？

一个 HTTP 请求其实很快的，比如我下面这个抓包，只需要 0.2 秒就完成了，远小于 MSL，所以延迟的 RST 报文存活是有可能的。

![图片](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-010.png)

#### 第二个问题

开启 tcp\_tw\_reuse 来快速复用 TIME\_WAIT 状态的连接，如果第四次挥手的 ACK 报文丢失了，服务端会触发超时重传，重传第三次挥手报文，处于 syn\_sent 状态的客户端收到服务端重传第三次挥手报文，则会回 RST 给服务端。如下图：

![](../../../assets/图解网络-小林coding/26-tcp_tw_reuse_close/img-011.png)

这时候有同学就问了，如果 TIME\_WAIT 状态被快速复用后，刚好第四次挥手的 ACK 报文丢失了，那客户端复用 TIME\_WAIT 状态后发送的 SYN 报文被处于 last\_ack 状态的服务端收到了会发生什么呢？

处于 last\_ack 状态的服务端收到了 SYN 报文后，会回复确认号与服务端上一次发送 ACK 报文一样的 ACK 报文，这个 ACK 报文称为 [Challenge ACK](https://xiaolincoding.com/network/3_tcp/challenge_ack.html) ，并不是确认收到 SYN 报文。

处于 syn\_sent 状态的客户端收到服务端的 [Challenge ACK](https://xiaolincoding.com/network/3_tcp/challenge_ack.html) 后，发现不是自己期望收到的确认号，于是就会回复 RST 报文，服务端收到后，就会断开连接。
...
> [!info] 原文信息
> 原文：[4.15 HTTPS 中 TLS 和 TCP 能同时握手吗？](https://xiaolincoding.com/network/3_tcp/tcp_tls.html)
> 提取：Defuddle 0.19.2
...
![图片](../../../assets/图解网络-小林coding/27-tcp_tls/img-001.jpg)
...
![图片](../../../assets/图解网络-小林coding/27-tcp_tls/img-002.png)
...
![图片](../../../assets/图解网络-小林coding/27-tcp_tls/img-003.jpg)
...
![图片](../../../assets/图解网络-小林coding/27-tcp_tls/img-004.png)
...
![图片](../../../assets/图解网络-小林coding/27-tcp_tls/img-005.png)
...
![图片](../../../assets/图解网络-小林coding/27-tcp_tls/img-006.png)
...
![图片](../../../assets/图解网络-小林coding/27-tcp_tls/img-007.png)
...
TLSv1.3 还有个更厉害的地方在于 **会话恢复** 机制，在 **重连 TLSv1.3 只需要 0-RTT** ，用“pre\_shared\_key”和“early\_data”扩展，在 TCP 连接后立即就建立安全连接发送加密消息，过程如下图：

![图片](../../../assets/图解网络-小林coding/27-tcp_tls/img-008.png)
...
> [!info] 原文信息
> 原文：[4.17 TCP 协议有什么缺陷？](https://xiaolincoding.com/network/3_tcp/tcp_problem.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/29-tcp_problem/img-001.gif)

TCP 三次握手的延迟被 TCP Fast Open （快速打开）这个特性解决了，这个特性可以在「第二次建立连接」时减少 TCP 连接建立的时延。

![常规 HTTP 请求 与 Fast  Open HTTP 请求](../../../assets/图解网络-小林coding/29-tcp_problem/img-002.png)
...
![](../../../assets/图解网络-小林coding/29-tcp_problem/img-003.png)
...
![](../../../assets/图解网络-小林coding/29-tcp_problem/img-004.gif)
...
![](../../../assets/图解网络-小林coding/29-tcp_problem/img-005.jpg)

### 网络迁移需要重新建立 TCP 连接

基于 TCP 传输协议的 HTTP 协议，由于是通过四元组（源 IP、源端口、目的 IP、目的端口）确定一条 TCP 连接。

![TCP 四元组](../../../assets/图解网络-小林coding/29-tcp_problem/img-006.png)
...
![](../../../assets/图解网络-小林coding/29-tcp_problem/img-007.png)

## 4.18 如何基于 UDP 协议实现可靠传输？

> [!info] 原文信息
> 原文：[4.18 如何基于 UDP 协议实现可靠传输？](https://xiaolincoding.com/network/3_tcp/quic.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/30-quic/img-001.png)
...
![](../../../assets/图解网络-小林coding/30-quic/img-002.png)

整体看的视角是这样的：

![](../../../assets/图解网络-小林coding/30-quic/img-003.png)
...
![Packet Header](../../../assets/图解网络-小林coding/30-quic/img-004.jpg)
...
![](../../../assets/图解网络-小林coding/30-quic/img-005.jpg)

> 为什么要这么设计呢？

我们先来看看 TCP 的问题，TCP 在重传报文时的序列号和原始报文的序列号是一样的，也正是由于这个特性，引入了 TCP 重传的歧义问题。

![TCP 重传的歧义问题](../../../assets/图解网络-小林coding/30-quic/img-006.jpg)
...
![](../../../assets/图解网络-小林coding/30-quic/img-007.png)
...
![](../../../assets/图解网络-小林coding/30-quic/img-010.jpg)
...
![接收窗口](../../../assets/图解网络-小林coding/30-quic/img-011.jpg)
...
![HTTP/2](../../../assets/图解网络-小林coding/30-quic/img-012.png)
...
![](../../../assets/图解网络-小林coding/30-quic/img-013.jpg)
...
![](../../../assets/图解网络-小林coding/30-quic/img-014.jpg)
...
![](../../../assets/图解网络-小林coding/30-quic/img-015.png)

接着，接收方收到了发送方发送过来的数据，有的数据被上层读取了，有的数据丢包了，此时的接收窗口状况如下：

![](../../../assets/图解网络-小林coding/30-quic/img-016.png)
...
![接收窗口触发的滑动](../../../assets/图解网络-小林coding/30-quic/img-017.png)
...
![Connection 流量控制](../../../assets/图解网络-小林coding/30-quic/img-023.png)
...
![](../../../assets/图解网络-小林coding/30-quic/img-024.png)

### QUIC 是如何迁移连接的？

基于 TCP 传输协议的 HTTP 协议，由于是通过四元组（源 IP、源端口、目的 IP、目的端口）确定一条 TCP 连接。

![TCP 四元组](../../../assets/图解网络-小林coding/30-quic/img-025.png)
...
> [!info] 原文信息
> 原文：[4.19 TCP 和 UDP 可以使用同一个端口吗？](https://xiaolincoding.com/network/3_tcp/port.html)
> 提取：Defuddle 0.19.2
...
![](../../../assets/图解网络-小林coding/31-port/img-001.png)
...
![](../../../assets/图解网络-小林coding/31-port/img-002.png)

UDP 网络编程如下，服务端是没有监听这个动作的，只有执行 bind() 系统调用来绑定端口的动作。

![](../../../assets/图解网络-小林coding/31-port/img-003.png)
...
![](../../../assets/图解网络-小林coding/31-port/img-004.jpg)
...
![](../../../assets/图解网络-小林coding/31-port/img-005.png)

运行这两个程序后，通过 netstat 命令可以看到，TCP 和 UDP 是可以同时绑定同一个端口号的。

![](../../../assets/图解网络-小林coding/31-port/img-006.png)
...
如果想多个进程绑定相同的 IP 地址和端口，也是有办法的，就是对 socket 设置 SO\_REUSEPORT 属性（内核 3.9 版本提供的新特性），本文不对 SO\_REUSEPORT 做具体介绍，感兴趣的同学自行去学习。
...
![](../../../assets/图解网络-小林coding/31-port/img-010.png)
...
而等 TIME\_WAIT 状态的连接结束后，重启 TCP 服务进程就能成功。

> 重启 TCP 服务进程时，如何避免“Address in use”的报错信息？

我们可以在调用 bind 前，对 socket 设置 SO\_REUSEADDR 属性，可以解决这个问题。
...
因为 SO\_REUSEADDR 作用是： **如果当前启动进程绑定的 IP+PORT 与处于TIME\_WAIT 状态的连接占用的 IP+PORT 存在冲突，但是新启动的进程使用了 SO\_REUSEADDR 选项，那么该进程就可以绑定成功** 。

举个例子，服务端有个监听 0.0.0.0 地址和 8888 端口的 TCP 服务进程。

![](../../../assets/图解网络-小林coding/31-port/img-011.png)

有个客户端（IP地址：192.168.1.100）已经和服务端（IP 地址：172.19.11.200）建立了 TCP 连接，那么在 TCP 服务进程重启时，服务端会与客户端经历四次挥手，服务端的 TCP 连接会短暂处于 TIME\_WAIT 状态：
...
如果 TCP 服务进程没有对 socket 设置 SO\_REUSEADDR 属性，那么在重启时，由于存在一个和绑定 IP+PORT 一样的 TIME\_WAIT 状态的连接，那么在执行 bind() 函数的时候，就会返回了 Address already in use 的错误。

如果 TCP 服务进程对 socket 设置 SO\_REUSEADDR 属性了，那么在重启时，即使存在一个和绑定 IP+PORT 一样的 TIME\_WAIT 状态的连接，依然可以正常绑定成功，因此可以正常重启成功。

因此，在所有 TCP 服务器程序中，调用 bind 之前最好对 socket 设置 SO\_REUSEADDR 属性，这不会产生危害，相反，它会帮助我们在很快时间内重启服务端程序。

**前面我提到过这个问题** ：如果 TCP 服务进程 A 绑定的地址是 0.0.0.0 和端口 8888，而如果 TCP 服务进程 B 绑定的地址是 192.168.1.100 地址（或者其他地址）和端口 8888，那么执行 bind() 时候也会出错。

这个问题也可以由 SO\_REUSEADDR 解决，因为它的 **另外一个作用** ：绑定的 IP地址 + 端口时，只要 IP 地址不是正好(exactly)相同，那么允许绑定。

比如，0.0.0.0:8888 和192.168.1.100:8888，虽然逻辑意义上前者包含了后者，但是 0.0.0.0 泛指所有本地 IP，而 192.168.1.100 特指某一IP，两者并不是完全相同，所以在对 socket 设置 SO\_REUSEADDR 属性后，那么执行 bind() 时候就会绑定成功。

### 客户端的端口可以重复使用吗？

客户端在执行 connect 函数的时候，会在内核里随机选择一个端口，然后向服务端发起 SYN 报文，然后与服务端进行三次握手。

![](../../../assets/图解网络-小林coding/31-port/img-012.png)
...
![](../../../assets/图解网络-小林coding/31-port/img-013.jpg)
...
如果客户端都是与同一个服务器（目标地址和目标端口一样）建立连接，那么如果客户端 TIME\_WAIT 状态的连接过多，当端口资源被耗尽，就无法与这个服务器再建立连接了。
...
前面我们提到，如果客户端都是与同一个服务器（目标地址和目标端口一样）建立连接，那么如果客户端 TIME\_WAIT 状态的连接过多，当端口资源被耗尽，就无法与这个服务器再建立连接了。

针对这个问题，也是有解决办法的，那就是打开 `net.ipv4.tcp_tw_reuse` 这个内核参数。

**因为开启了这个内核参数后，客户端调用 connect 函数时，如果选择到的端口，已经被相同四元组的连接占用的时候，就会判断该连接是否处于 TIME\_WAIT 状态，如果该连接处于 TIME\_WAIT 状态并且 TIME\_WAIT 状态持续的时间超过了 1 秒，那么就会重用这个连接，然后就可以正常使用该端口了。**

举个例子，假设客户端已经与服务器建立了一个 TCP 连接，并且这个状态处于 TIME\_WAIT 状态：
...
- 如果 **没有开启** net.ipv4.tcp\_tw\_reuse 内核参数，那么内核就会选择下一个端口，然后继续判断，直到找到一个没有被相同四元组的连接使用的端口， 如果端口资源耗尽还是没找到，那么 connect 函数就会返回错误。
- 如果 **开启** 了 net.ipv4.tcp\_tw\_reuse 内核参数，就会判断该四元组的连接状态是否处于 TIME\_WAIT 状态， **如果连接处于 TIME\_WAIT 状态并且该状态持续的时间超过了 1 秒，那么就会重用该连接** ，于是就可以使用 2222 端口了，这时 connect 就会返回成功。

再次提醒一次，开启了 net.ipv4.tcp\_tw\_reuse 内核参数，是客户端（连接发起方） 在调用 connect() 函数时才起作用，所以在服务端开启这个参数是没有效果的。

> 客户端端口选择的流程总结

至此，我们已经把客户端在执行 connect 函数时，内核选择端口的情况大致说了一遍，为了让大家更明白客户端端口的选择过程，我画了一流程图。

![](../../../assets/图解网络-小林coding/31-port/img-014.png)
...
> [!info] 原文信息
> 原文：[4.21 没有 accept，能建立 TCP 连接吗？](https://xiaolincoding.com/network/3_tcp/tcp_no_accpet.html)
> 提取：Defuddle 0.19.2
...
![握手建立连接流程](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-001.gif)
...
![不执行accept时抓包结果](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-002.png)
...
![TCP三次握手](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-003.png)

服务端代码，对socket执行bind方法可以绑定监听端口，然后执行 `listen方法` 后，就会进入监听（ `LISTEN` ）状态。内核会为每一个处于 `LISTEN` 状态的 `socket` 分配两个队列，分别叫 **半连接队列和全连接队列** 。

![每个listen Socket都有一个全连接和半连接队列](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-004.png)

#### 半连接队列、全连接队列是什么

![半连接队列和全连接队列](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-005.png)
...
虽然都叫 **队列** ，但其实 **全连接队列（icsk\_accept\_queue）是个链表** ，而 **半连接队列（syn\_table）是个哈希表** 。

![半连接全连接队列的内部结构](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-006.png)
...
![tcp_abort_on_overflow为0](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-007.png)
...
![tcp_abort_on_overflow为1](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-008.png)
...
![syn攻击](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-009.png)
...
![tcp_syncookies=1](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-010.png)
...
![tcp报头_seq的位置](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-011.png)
...
![ack攻击](../../../assets/图解网络-小林coding/33-tcp_no_accpet/img-012.gif)
...
> [!info] 原文信息
> 原文：[4.22 用了 TCP 协议，数据一定不会丢吗？](https://xiaolincoding.com/network/3_tcp/tcp_drop.html)
> 提取：Defuddle 0.19.2
...
![聊天软件三端通信](../../../assets/图解网络-小林coding/34-tcp_drop/img-001.png)

但为了 **简化模型** ，我们把中间的服务器给省略掉，假设这是个端到端的通信。且为了保证消息的可靠性，我们盲猜它们之间用的是 **TCP协议** 进行通信。

![聊天软件两端通信](../../../assets/图解网络-小林coding/34-tcp_drop/img-002.png)
...
![网络发包收包全景图](../../../assets/图解网络-小林coding/34-tcp_drop/img-003.png)
...
![TCP三次握手](../../../assets/图解网络-小林coding/34-tcp_drop/img-004.png)
...
![半连接队列和全连接队列](../../../assets/图解网络-小林coding/34-tcp_drop/img-005.png)
...
![图片](../../../assets/图解网络-小林coding/34-tcp_drop/img-006.png)
...
![qdisc丢包](../../../assets/图解网络-小林coding/34-tcp_drop/img-007.png)
...
![RingBuffer满了导致丢包](../../../assets/图解网络-小林coding/34-tcp_drop/img-008.png)
...
![tcp_sendmsg逻辑](../../../assets/图解网络-小林coding/34-tcp_drop/img-009.png)
...
![ping查看丢包](../../../assets/图解网络-小林coding/34-tcp_drop/img-013.png)
...
![mtr_icmp](../../../assets/图解网络-小林coding/34-tcp_drop/img-014.png)
...
![mtr-udp](../../../assets/图解网络-小林coding/34-tcp_drop/img-015.png)
...
![图片](../../../assets/图解网络-小林coding/34-tcp_drop/img-016.png)
...
![TCP是什么](../../../assets/图解网络-小林coding/34-tcp_drop/img-017.png)
...
![图片](../../../assets/图解网络-小林coding/34-tcp_drop/img-018.png)
...
![四层网络协议](../../../assets/图解网络-小林coding/34-tcp_drop/img-019.png)
...
![使用TCP协议却发生丢包](../../../assets/图解网络-小林coding/34-tcp_drop/img-020.png)
...
![聊天软件三端通信](../../../assets/图解网络-小林coding/34-tcp_drop/img-021.png)
...
> [!info] 原文信息
> 原文：[4.24 TCP 序列号和确认号是如何变化的？](https://xiaolincoding.com/network/3_tcp/tcp_seq_ack.html)
> 提取：Defuddle 0.19.2
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/36-tcp_seq_ack/img-001.png)
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/36-tcp_seq_ack/img-002.png)
...
- 确认号设置为 client\_isn + 1，服务端上一次收到的报文是客户端发来的 SYN 报文，该报文的 seq = client\_isn，那么根据公式 2（ *确认号 = 上一次收到的报文中的序列号 + len。特殊情况，如果收到的是 SYN 报文或者 FIN 报文，则改为 + 1* ），可以得出当前确认号 = client\_isn + 1。

客户端收到服务端的 SYN-ACK 报文后，会将 ACK 报文（第三次握手报文）中序列号和确认号分别设置为：

- 序列号设置为 client\_isn + 1。客户端上一次发送报文是 SYN 报文，SYN 的序列号为 client\_isn，根据公式 1（ *序列号 = 上一次发送的序列号 + len。特殊情况，如果上一次发送的报文是 SYN 报文或者 FIN 报文，则改为 + 1* ），所以当前的序列号为 client\_isn + 1。
- 确认号设置为 server\_isn + 1，客户端上一次收到的报文是服务端发来的 SYN-ACK 报文，该报文的 seq = server\_isn，那么根据公式 2（ *确认号 = 收到的报文中的序列号 + len。特殊情况，如果收到的是 SYN 报文或者 FIN 报文，则改为 + 1* ），可以得出当前确认号 = server\_isn + 1。
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/36-tcp_seq_ack/img-003.png)

客户端发送 10 字节的数据，通常 TCP 数据报文的控制位是 \[PSH, ACK\]，此时该 TCP 数据报文的序列号和确认号分别设置为：

- 序列号设置为 client\_isn + 1。客户端上一次发送报文是 ACK 报文（第三次握手），该报文的 seq = client\_isn + 1，由于是一个单纯的 ACK 报文，没有携带用户数据，所以 len = 0。根据公式 1（ *序列号 = 上一次发送的序列号 + len* ），可以得出当前的序列号为 client\_isn + 1 + 0，即 client\_isn + 1。
...
- 序列号设置为 server\_isn + 1。服务端上一次发送报文是 SYN-ACK 报文，序列号为 server\_isn，根据公式 1（ *序列号 = 上一次发送的序列号 + len。特殊情况，如果上一次发送的报文是 SYN 报文或者 FIN 报文，则改为 + 1* ），所以当前的序列号为 server\_isn + 1。
- 确认号设置为 client\_isn + 11 。服务端上一次收到的报文是客户端发来的 10 字节 TCP 数据报文，该报文的 seq = client\_isn + 1，len = 10。根据公式 2（ *确认号 = 上一次收到的报文中的序列号 + len* ），也就是将「收到的 TCP 数据报文中的序列号 client\_isn + 1，再加上 10（len = 10） 」的值作为了确认号，表示自己收到了该 10 字节的数据报文。
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/36-tcp_seq_ack/img-004.png)
...
![在这里插入图片描述](../../../assets/图解网络-小林coding/36-tcp_seq_ack/img-005.png)

客户端发送的第一次挥手的序列号和确认号分别设置为：

- 序列号设置为 client\_isn + 11。客户端上一次发送的报文是 \[PSH, ACK\] ，该报文的 seq = client\_isn + 1, len = 10，根据公式 1（ *序列号 = 上一次发送的序列号 + len* ），可以得出当前的序列号为 client\_isn + 11。
...
- 序列号设置为 server\_isn + 1。服务端上一次发送的报文是 ACK 报文，该报文的 seq = server\_isn + 1，而该报文是单纯的 ACK 报文，不携带用户数据，所以 len 为 0，根据公式 1（ *序列号 = 上一次发送的序列号 + len* ），可以得出当前的序列号为 server\_isn + 1 + 0 （len = 0），也就是 server\_isn + 1。
- 确认号设置为 client\_isn + 12。服务端上一次收到的报文是客户端发来的 FIN 报文，该报文的 seq = client\_isn + 11，根据公式 2（\_确认号= *上一次\_收到的序列号 + len，特殊情况，如果收到报文是 SYN 报文或者 FIN 报文，则改为 + 1* ），可以得出当前的确认号为 client\_isn + 11 + 1，也就是 client\_isn + 12。
...
- 序列号设置为 client\_isn + 12。客户端上一次发送的报文是 FIN 报文，该报文的 seq = client\_isn + 11，根据公式 1（ *序列号 = 上一次发送的序列号 + len。特殊情况，如果收到报文是 SYN 报文或者 FIN 报文，则改为 + 1* ），可以得出当前的序列号为 client\_isn + 11 + 1，也就是 client\_isn + 12。
- 确认号设置为 server\_isn + 2。客户端上一次收到的报文是服务端发来的 FIN 报文，该报文的 seq = server\_isn + 1，根据公式 2（\_确认号 = *上一次\_收到的序列号 + len，特殊情况，如果收到报文是 SYN 报文或者 FIN 报文，则改为 + 1* ），可以得出当前的确认号为 server\_isn + 1 + 1，也就是 server\_isn + 2。

### 实际抓包图

在这里贴一个，实际过程中的抓包图。

![在这里插入图片描述](../../../assets/图解网络-小林coding/36-tcp_seq_ack/img-006.png)
...
> [!info] 原文信息
> 原文：[5.1 IP 基础知识全家桶](https://xiaolincoding.com/network/4_ip/ip_base.html)
> 提取：Defuddle 0.19.2
...
![IP 基础知识全家桶](../../../assets/图解网络-小林coding/37-ip_base/img-001.png)
...
![IP 的作用](../../../assets/图解网络-小林coding/37-ip_base/img-002.png)
...
![IP 的作用与 MAC 的作用](../../../assets/图解网络-小林coding/37-ip_base/img-003.png)
...
![点分十进制](../../../assets/图解网络-小林coding/37-ip_base/img-004.png)

那么，IP 地址最大值也就是

![](../../../assets/图解网络-小林coding/37-ip_base/img-005.png)

也就说，最大允许 43 亿台计算机连接到网络。

实际上，IP 地址并不是根据主机台数来配置的，而是以网卡。像服务器、路由器等设备都是有 2 个以上的网卡，也就是它们会有 2 个以上的 IP 地址。

![每块网卡可以分配一个以上的IP地址](../../../assets/图解网络-小林coding/37-ip_base/img-006.png)
...
![IP 地址分类](../../../assets/图解网络-小林coding/37-ip_base/img-007.png)
...
![](../../../assets/图解网络-小林coding/37-ip_base/img-008.png)

> A、B、C 分类地址最大主机个数是如何计算的呢？

最大主机个数，就是要看主机号的位数，如 C 类地址的主机号占 8 位，那么 C 类地址的最大主机个数：

![](../../../assets/图解网络-小林coding/37-ip_base/img-009.png)

为什么要减 2 呢？

因为在 IP 地址中，有两个 IP 是特殊的，分别是主机号全为 1 和 全为 0 地址。

![](../../../assets/图解网络-小林coding/37-ip_base/img-010.png)
...
![本地广播与直接广播](../../../assets/图解网络-小林coding/37-ip_base/img-011.png)

> 什么是 D、E 类地址？

而 D 类和 E 类地址是没有主机号的，所以不可用于主机 IP，D 类常被用于 **多播** ，E 类是预留的分类，暂时未使用。

![](../../../assets/图解网络-小林coding/37-ip_base/img-012.png)
...
![单播、广播、多播通信](../../../assets/图解网络-小林coding/37-ip_base/img-013.png)
...
![IP 分类判断](../../../assets/图解网络-小林coding/37-ip_base/img-014.png)
...
![](../../../assets/图解网络-小林coding/37-ip_base/img-015.png)

还有另一种划分网络号与主机号形式，那就是 **子网掩码** ，掩码的意思就是掩盖掉主机号，剩余的就是网络号。

**将子网掩码和 IP 地址按位计算 AND，就可得到网络号。**

![](../../../assets/图解网络-小林coding/37-ip_base/img-016.jpg)
...
![IP地址的网络号](../../../assets/图解网络-小林coding/37-ip_base/img-017.png)
...
![](../../../assets/图解网络-小林coding/37-ip_base/img-018.png)
...
![](../../../assets/图解网络-小林coding/37-ip_base/img-019.png)

由于子网网络地址被划分成 2 位，那么子网地址就有 4 个，分别是 00、01、10、11，具体划分如下图：

![](../../../assets/图解网络-小林coding/37-ip_base/img-020.png)

划分后的 4 个子网如下表格：

![](../../../assets/图解网络-小林coding/37-ip_base/img-021.png)

#### 公有 IP 地址与私有 IP 地址

在 A、B、C 分类地址，实际上有分公有 IP 地址和私有 IP 地址。

![](../../../assets/图解网络-小林coding/37-ip_base/img-022.png)
...
![公有 IP 地址与私有 IP 地址](../../../assets/图解网络-小林coding/37-ip_base/img-023.png)
...
![](../../../assets/图解网络-小林coding/37-ip_base/img-024.png)
...
![IP 地址与路由控制](../../../assets/图解网络-小林coding/37-ip_base/img-025.png)
...
![分片与重组](../../../assets/图解网络-小林coding/37-ip_base/img-026.png)
...
![IPv6 地址表示方法](../../../assets/图解网络-小林coding/37-ip_base/img-027.png)

如果出现连续的 0 时还可以将这些 0 省略，并用两个冒号 「::」隔开。但是，一个 IP 地址中只允许出现一次两个连续的冒号。

![Pv6 地址缺省表示方](../../../assets/图解网络-小林coding/37-ip_base/img-028.png)
...
![IPv6地址结构](../../../assets/图解网络-小林coding/37-ip_base/img-029.png)
...
![ IPv6 中的单播通信](../../../assets/图解网络-小林coding/37-ip_base/img-030.png)

#### IPv4 首部与 IPv6 首部

IPv4 首部与 IPv6 首部的差异如下图：

![IPv4 首部与 IPv6 首部的差异](../../../assets/图解网络-小林coding/37-ip_base/img-031.png)
...
![DNS 树状结构](../../../assets/图解网络-小林coding/37-ip_base/img-032.png)
...
![域名解析的工作流程](../../../assets/图解网络-小林coding/37-ip_base/img-033.png)
...
![ARP 广播](../../../assets/图解网络-小林coding/37-ip_base/img-034.png)
...
![RARP](../../../assets/图解网络-小林coding/37-ip_base/img-035.png)
...
![DHCP 工作流程](../../../assets/图解网络-小林coding/37-ip_base/img-036.png)
...
![ DHCP 中继代理](../../../assets/图解网络-小林coding/37-ip_base/img-037.png)
...
![NAT](../../../assets/图解网络-小林coding/37-ip_base/img-038.png)
...
![NAPT](../../../assets/图解网络-小林coding/37-ip_base/img-039.png)
...
![ICMP 目标不可达消息](../../../assets/图解网络-小林coding/37-ip_base/img-040.png)
...
![常见的 ICMP 类型](../../../assets/图解网络-小林coding/37-ip_base/img-041.png)
...
![组播模型](../../../assets/图解网络-小林coding/37-ip_base/img-042.png)
...
![ IGMP 常规查询与响应工作机制](../../../assets/图解网络-小林coding/37-ip_base/img-043.png)
...
![ IGMPv2 离开组播组工作机制 情况1](../../../assets/图解网络-小林coding/37-ip_base/img-044.png)
...
![ IGMPv2 离开组播组工作机制 情况2](../../../assets/图解网络-小林coding/37-ip_base/img-045.png)
...
> [!info] 原文信息
> 原文：[5.2 ping 的工作原理](https://xiaolincoding.com/network/4_ip/ping.html)
> 提取：Defuddle 0.19.2
...
![来自面试官的灵魂拷问](../../../assets/图解网络-小林coding/38-ping/img-001.jpg)

不知道的小伙伴也没关系，今天我们就来搞定它，搞懂它。消除本次的问号， **让问号少一点** 。

![](../../../assets/图解网络-小林coding/38-ping/img-002.gif)
...
![ICMP 目标不可达消息](../../../assets/图解网络-小林coding/38-ping/img-003.png)
...
![ICMP 报文](../../../assets/图解网络-小林coding/38-ping/img-004.png)
...
![常见的 ICMP 类型](../../../assets/图解网络-小林coding/38-ping/img-005.png)
...
![ICMP 回送消息](../../../assets/图解网络-小林coding/38-ping/img-006.png)

可以向对端主机发送 **回送请求** 的消息（ `ICMP Echo Request Message` ，类型 `8` ），也可以接收对端主机发回来的 **回送应答** 消息（ `ICMP Echo Reply Message` ，类型 `0` ）。

![ICMP 回送请求和回送应答报文](../../../assets/图解网络-小林coding/38-ping/img-007.png)
...
![目标不可达类型的常见代码号](../../../assets/图解网络-小林coding/38-ping/img-008.png)
...
![外卖员 —— 小林](../../../assets/图解网络-小林coding/38-ping/img-009.png)
...
![ICMP 时间超过消息](../../../assets/图解网络-小林coding/38-ping/img-010.png)
...
![主机 A ping 主机 B](../../../assets/图解网络-小林coding/38-ping/img-011.png)
...
![主机 A 的 ICMP 回送请求报文](../../../assets/图解网络-小林coding/38-ping/img-012.png)
...
![主机 A 的 IP 层数据包](../../../assets/图解网络-小林coding/38-ping/img-013.png)

接下来，需要加入 `MAC` 头。如果在本地 ARP 映射表中查找出 IP 地址 192.168.1.2 所对应的 MAC 地址，则可以直接使用；如果没有，则需要发送 `ARP` 协议查询 MAC 地址，获得 MAC 地址后，由数据链路层构建一个数据帧，目的地址是 IP 层传过来的 MAC 地址，源地址则是本机的 MAC 地址；还要附加上一些控制信息，依据以太网的介质访问规则，将它们传送出去。

![主机 A 的 MAC 层数据包](../../../assets/图解网络-小林coding/38-ping/img-014.png)
...
![主机 B 的 ICMP 回送响应报文](../../../assets/图解网络-小林coding/38-ping/img-015.png)
...
![主机 A ping 主机 B 期间发送的事情](../../../assets/图解网络-小林coding/38-ping/img-016.png)
...
![MTU 路径发现（UDP的情况下）](../../../assets/图解网络-小林coding/38-ping/img-017.png)
...
> [!info] 原文信息
> 原文：[5.3 断网了，还能 ping 通 127.0.0.1 吗？](https://xiaolincoding.com/network/4_ip/ping_lo.html)
> 提取：Defuddle 0.19.2
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-001.gif)

话不多说，我们直接开车。

拔掉网线，断网。

![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-002.jpg)
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-003.png)
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-004.png)
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-005.png)
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-006.png)
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-007.png)
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-008.png)
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-009.png)

ping 本机地址:

![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-010.png)
...
![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-011.png)

访问localhost:80

![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-012.png)

访问0.0.0.0:80

![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-013.png)

访问本机的IP地址

![图片](../../../assets/图解网络-小林coding/39-ping_lo/img-014.png)
