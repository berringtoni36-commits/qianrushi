...
1. [原作者开发文档](linux物理内存检测工具原作者开发文档.md)和原作者 PDF：理解项目设计、内核挂点和指标含义。
2. [extfraginfo.c](extfraginfo.c)、[fraginfo.c](fraginfo.c)、[exfrag.py](exfrag.py)、[exfrag_user.py](exfrag_user.py)：核对当前源码的真实行为。
3. [上次复习文档](linux-ebpf内存碎片监控复习.md)：补充面试表达、易混点和记忆方式。
4. [纯题目版](linux物理内存检测面试高频点.md)：确定题目顺序。
...
![Tracepoint 与 kprobe 对比](projects/Linux物理内存检测项目/源码/assets/interview-svg/tracepoint-kprobe_animated.svg)
...
![BPF Map 双向数据流](projects/Linux物理内存检测项目/源码/assets/interview-svg/bpf-map-data-flow_animated.svg)
...
![Python、BCC、eBPF 和 curses 分层](projects/Linux物理内存检测项目/源码/assets/interview-svg/project-data-flow_animated.svg)
...
![外部碎片导致连续页不足](projects/Linux物理内存检测项目/源码/assets/interview-svg/external-fragmentation_animated.svg)
...
![伙伴系统快速路径与慢速路径](projects/Linux物理内存检测项目/源码/assets/interview-svg/buddy-allocation-path_animated.svg)
...
![事件与状态双探针协作](projects/Linux物理内存检测项目/源码/assets/interview-svg/event-state-correlation_animated.svg)
...
![两个碎片化指标的含义和判断](projects/Linux物理内存检测项目/源码/assets/interview-svg/fragmentation-index-logic_animated.svg)
...
![Linux 物理内存碎片检测完整运行链路](projects/Linux物理内存检测项目/源码/assets/interview-svg/project-data-flow_animated.svg)
...
![采样节流的设计与当前源码问题](projects/Linux物理内存检测项目/源码/assets/interview-svg/sampling-throttle_animated.svg)
