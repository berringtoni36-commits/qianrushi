...
chapter: "第4章 套接字通信"
order: 6
source: "https://subingwen.cn/linux/socket-class/"
author: "苏丙榅"
...
[[archive/大丙Linux教程/第4章 套接字通信/index|← 返回本章目录]] · [[05 TCP数据粘包的处理|上一篇：TCP数据粘包的处理]] · [[07 IO多路转接（复用）之select|下一篇：IO多路转接（复用）之select →]]
