---
title: "IO多路转接（复用）之poll"
chapter: "第4章 套接字通信"
order: 8
source: "https://subingwen.cn/linux/poll/"
author: "苏丙榅"
...
[[archive/大丙Linux教程/第4章 套接字通信/index|← 返回本章目录]] · [[07 IO多路转接（复用）之select|上一篇：IO多路转接（复用）之select]] · [[09 IO多路转接（复用）之epoll|下一篇：IO多路转接（复用）之epoll →]]
