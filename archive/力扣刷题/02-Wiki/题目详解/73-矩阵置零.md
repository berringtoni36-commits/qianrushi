...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《73. 矩阵置零 (Medium)》。"
---
...
- [[54-螺旋矩阵|54-螺旋矩阵]] — 同样是矩阵遍历/修改问题，但其核心技术是边界收缩法。
- [[48-旋转图像|48-旋转图像]] — 矩阵变换问题，核心思路是将复杂旋转拆解为转置+翻转两步。
- [[73-矩阵置零|73-矩阵置零]] 是矩阵原地标记的代表，与之类似的问题还有 289-生命游戏，也是根据邻居状态原地更新矩阵。
