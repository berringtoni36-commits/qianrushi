...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《207. 课程表 (Medium)》。"
---
...
- [[994-腐烂的橘子|994-腐烂的橘子]] — BFS 在图论中的另一种应用：多源 BFS 求最短扩散时间。207 是 BFS 做拓扑排序，994 是 BFS 做层序遍历，两者虽然都用队列但目的不同。
- [[200-岛屿数量|200-岛屿数量]] — 图遍历的基础题，DFS/BFS 遍历二维网格图。207 则是在有向图上进行拓扑排序。
