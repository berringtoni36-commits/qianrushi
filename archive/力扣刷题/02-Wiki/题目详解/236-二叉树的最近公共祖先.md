...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《236. 二叉树的最近公共祖先 (Medium)》。"
---
...
- **数据范围含义：** 最多 10^5 个节点，非常大的数据量，要求 O(n) 时间、O(h) 空间的算法。递归深度可能达到 10^5（链状树），C++ 默认递归深度可能不够，但面试中一般不会拿链状树来卡递归解法。迭代法更安全。
...
- [[124-二叉树中的最大路径和|124-二叉树中的最大路径和]] — 同样是后序遍历的应用，需要在后序位置整合左右子树的信息。
