...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《287. 寻找重复数 (Medium)》。"
---
...
- [[142-环形链表II|142-环形链表II]] — Floyd 判圈法的链表版本，完全相同的算法思想
- [[141-环形链表|141-环形链表]] — 检测链表是否有环，Floyd 判圈法的简化版
- [[41-缺失的第一个正数|41-缺失的第一个正数]] — 与本题类似都是利用数组下标与值的映射关系，但用的是原地哈希
