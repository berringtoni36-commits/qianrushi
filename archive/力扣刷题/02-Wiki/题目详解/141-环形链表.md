...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《141. 环形链表 (Easy)》。"
---
...
public:
    bool hasCycle(ListNode* head) {
        unordered_set<ListNode*> seen; while(head){ if(!seen.insert(head).second) return true; head=head->next; } return false;
    }
};
```
---
...
- [[142-环形链表II|142-环形链表II]] — 不仅判环，还要找到环的入口，是本题的直接进阶
- [[160-相交链表|160-相交链表]] — 双指针消除长度差的思路类似
- [[287-寻找重复数|287-寻找重复数]] — 将数组看作链表，用 Floyd 判圈法找到重复数
