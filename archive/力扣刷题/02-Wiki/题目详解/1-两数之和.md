...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《1. 两数之和 (Easy)》。"
---
...
![[archive/力扣刷题/04-Outputs/LeetCode动画-V2/试点/1-两数之和/Obsidian预览]]
...
public:
    vector<int> twoSum(vector<int>& nums, int target) {
        ...
        for (int i = 0; i < nums.size(); i ++) {
            ...
            if (pos.count(need) && pos[need] != i) return {i, pos[need]};
        }
        return {};
    }
};
...
- [[15-三数之和|15-三数之和]] — 从两数之和扩展到三数之和，排序 + 双指针解决，去重成为新增的难点
