...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《160. 相交链表 (Easy)》。"
---
...
public:
    ListNode* getIntersectionNode(ListNode* a, ListNode* b) {
        unordered_set<ListNode*> seen; for(auto p=a;p;p=p->next) seen.insert(p); for(auto p=b;p;p=p->next) if(seen.count(p)) return p; return nullptr;
    }
};
```
### 思路三：长度差法
...
- [[141-环形链表|141-环形链表]] — 同样是快慢/双指针思想，判断链表是否有环
- [[142-环形链表II|142-环形链表II]] — 双指针找环入口，与本题的「等路程相遇」数学原理相似
