...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《21. 合并两个有序链表 (Easy)》。"
---
...
- [[23-合并K个升序链表|23-合并K个升序链表]] — 从两个扩展到 K 个，可以用分治或最小堆
- [[148-排序链表|148-排序链表]] — 链表的归并排序，合并操作直接复用本题代码
- [[2-两数相加|2-两数相加]] — 同步遍历两个链表，处理进位逻辑
