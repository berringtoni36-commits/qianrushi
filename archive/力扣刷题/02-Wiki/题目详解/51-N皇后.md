...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《51. N 皇后 (Hard)》。"
---
...
- [[46-全排列|46-全排列]] — N 皇后本质是排列问题的变体：每行选一列 = 对列索引做全排列，再附加对角线约束。理解全排列是理解 N 皇后的基础。
- [[79-单词搜索|79-单词搜索]] — 同样是回溯 + 棋盘，但 N 皇后是逐行放置，单词搜索是逐格 DFS 匹配。对比理解"棋盘放置类"和"棋盘搜索类"问题的区别。
