...
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《74. 搜索二维矩阵 (Medium)》。"
---
...
- [[240-搜索二维矩阵II|240-搜索二维矩阵II]] — 矩阵仅保证每行升序、每列升序，但不能展开为一维有序数组，需要用"右上角搜索法"，O(m+n) 时间。
- [[33-搜索旋转排序数组|33-搜索旋转排序数组]] — 一维数组上的二分变体，与本题的"有序空间"二分思想一脉相承。
- [[35-搜索插入位置|35-搜索插入位置]] — 最基础的一维二分查找，熟练掌握后解决本题的一维展开就非常自然。
- [[34-在排序数组中查找元素首末位置|34-在排序数组中查找元素首末位置]] — 二分边界查找的进阶应用，与本题的一维二分核心相同。
