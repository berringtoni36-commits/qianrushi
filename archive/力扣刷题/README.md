---
title: "力扣百题通 · C++17 在线刷题版"
tags: [tech, project]
created: 2026-07-15
type: permanent
summary: "C++17 Hot 100 项目中的《力扣百题通 · C++17 在线刷题版》。"
---
...
[![C++](https://img.shields.io/badge/C++17-刷题语言-00599C?logo=cplusplus)](https://isocpp.org/)
...
本项目是一个完整的 **LeetCode Hot 100 算法学习体系**（力扣百题通），以 Obsidian 知识库为载体，专为有 C++ 基础的学习者设计。
...
- **融合式模板体系** — [[00-YXC常用模板索引|YXC 常用模板索引]]保留原有优秀教学模板，并补充 YXC 原型与 LeetCode C++17/STL 融合版；[[Hot100两周速通-yxc简洁代码|YXC 简洁代码总文档]]仍是 100 题唯一最终提交版

![知识图谱界面参考](assets/leetcode/知识图谱界面参考.png)
...
│   ├── Hot100两周速通-yxc简洁代码.md   # 题面、思路、双站链接和唯一最终提交代码
│   ├── 03-Hot100学习教程与题目详解.md  # 算法模板与题目详解
│
├── 02-Wiki/                             # 核心知识区（结构化内容）
│   ├── 专题总结/                       # 1 个模板索引 + 13 个专题总结
│   │   ├── 00-YXC常用模板索引.md
│   │   ├── 01-哈希表.md
│   │   ├── 02-双指针与滑动窗口.md
│   │   ├── 03-数组与矩阵.md
...
**难度分布：** Easy 20 题 / Medium 68 题 / Hard 12 题
...
- **本质理解** — 一句话定义核心思想
- **应用场景分类表** — 什么时候用、怎么用
- **C++ 工具/数据结构对比** — `unordered_map`、`map`、`set`、`unordered_set`、`deque` 与 `priority_queue`
- **融合式模板** — 原有教学模板、YXC 原型、LeetCode C++17/STL 适配版并存；按题目场景选择，不机械替换
- **可运行的 C++ 代码模板** — 直接复制使用
- **模板变体及优化** — 覆盖常见变形
