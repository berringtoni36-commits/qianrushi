...
metadata:
  ...
  source_files:
    ...
    - projects/嵌入式八股/糯叽叽八股/11 Bootloader与Rootfs.md
  source_chapter: projects/嵌入式八股/3. 杂七杂八/5；糯叽叽八股/11
  source_symbols: [BootROM, SPL, DDR, U-Boot, device tree, bootargs, rootfs, init, PID1, serial console, last-known-good-stage]
